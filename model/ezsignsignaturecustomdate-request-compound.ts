...
/**
 * @export 
 * A EzsignsignaturecustomdateRequestCompound Object with automatic temp default value
 * Use this object only for create an empty object to assign a response from server
 * @class DefaultObjectEzsignsignaturecustomdateRequestCompound
 */
export class DefaultObjectEzsignsignaturecustomdateRequestCompound extends DefaultObject {
