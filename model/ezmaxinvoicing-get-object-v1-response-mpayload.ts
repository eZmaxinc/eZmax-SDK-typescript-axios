 ...
 * @export
 */
export type EzmaxinvoicingGetObjectV1ResponseMPayload = EzmaxinvoicingResponseCompound;


/**
 * @export 
 * A EzmaxinvoicingGetObjectV1ResponseMPayload Object with automatic temp default value
 * Use this object only for create an empty object to assign a response from server
 * @class DefaultObjectEzmaxinvoicingGetObjectV1ResponseMPayload
 */
export class DefaultObjectEzmaxinvoicingGetObjectV1ResponseMPayload extends DefaultObject {
