...
// May contain unused imports in some cases
// @ts-ignore
import type { EzsigntemplatesignaturepaymentdetailResponseCompound } from './ezsigntemplatesignaturepaymentdetail-response-compound';
// May contain unused imports in some cases
// @ts-ignore
...
/**
 * @type EzsigntemplatesignatureResponseCompoundV4
 * A Ezsigntemplatesignature Object
 */
/*export type EzsigntemplatesignatureResponseCompoundV4 = EzsigntemplatesignatureResponse;*/
export interface EzsigntemplatesignatureResponseCompoundV4 {
    /**
     * The unique ID of the Ezsigntemplatesignature
     * @type {number}
     * @memberof EzsigntemplatesignatureResponseCompoundV4
     */
    ...
    /**
     * 
     * @type {Array<EzsigntemplatesignaturepaymentdetailResponseCompound>}
     * @memberof EzsigntemplatesignatureResponseCompoundV4
     */
    a_objEzsigntemplatesignaturepaymentdetail?:Array<EzsigntemplatesignaturepaymentdetailResponseCompound> 
}
...
/**
 * @export 
 * A EzsigntemplatesignatureResponseCompoundV4 Data Object with automatic temporary default value
 * Use this object only for create an empty data object to assign a response from server
 * @class DataObjectEzsigntemplatesignatureResponseCompoundV4
 */
export class DataObjectEzsigntemplatesignatureResponseCompoundV4 {
    ...
    a_objEzsigntemplatesignaturepaymentdetail?:Array<EzsigntemplatesignaturepaymentdetailResponseCompound> = undefined
}

/**
 * @export 
 * A EzsigntemplatesignatureResponseCompoundV4 Validation Object
 * @class ValidationObjectEzsigntemplatesignatureResponseCompoundV4
 */
export class ValidationObjectEzsigntemplatesignatureResponseCompoundV4 {
