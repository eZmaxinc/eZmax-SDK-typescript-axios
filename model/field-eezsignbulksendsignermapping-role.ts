...
export const FieldEEzsignbulksendsignermappingRole = {
    CC: 'CC',
    Signer: 'Signer',
    SignerAndCC: 'SignerAndCC',
} as const;

export type FieldEEzsignbulksendsignermappingRole = typeof FieldEEzsignbulksendsignermappingRole[keyof typeof FieldEEzsignbulksendsignermappingRole];
