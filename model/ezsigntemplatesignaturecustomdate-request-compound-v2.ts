...
// @ts-ignore
import { EzsigntemplatesignaturecustomdateRequestV2 } from './ezsigntemplatesignaturecustomdate-request-v2';

/**
 * @type EzsigntemplatesignaturecustomdateRequestCompoundV2
 * An Ezsigntemplatesignaturecustomdate Object and children to create a complete structure
 * @export
 */
/*export type EzsigntemplatesignaturecustomdateRequestCompoundV2 = EzsigntemplatesignaturecustomdateRequestV2;*/
export interface EzsigntemplatesignaturecustomdateRequestCompoundV2 {
    /**
     * The unique ID of the Ezsigntemplatesignaturecustomdate
     * @type {number}
     * @memberof EzsigntemplatesignaturecustomdateRequestCompoundV2
     */
...
/**
 * @export 
 * A EzsigntemplatesignaturecustomdateRequestCompoundV2 Data Object with automatic temporary default value
 * Use this object only for create an empty data object to assign a response from server
 * @class DataObjectEzsigntemplatesignaturecustomdateRequestCompoundV2
 */
export class DataObjectEzsigntemplatesignaturecustomdateRequestCompoundV2 {
...
/**
 * @export 
 * A EzsigntemplatesignaturecustomdateRequestCompoundV2 Validation Object
 * @class ValidationObjectEzsigntemplatesignaturecustomdateRequestCompoundV2
 */
export class ValidationObjectEzsigntemplatesignaturecustomdateRequestCompoundV2 {
