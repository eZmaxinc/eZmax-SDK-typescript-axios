...
/**
 * A EzsignfoldertypeCreateObjectV1ResponseMPayload Object with automatic temp default value
 * Use this object only for create an empty object to assign a response from server
 * @export 
 * @class DefaultObjectEzsignfoldertypeCreateObjectV1ResponseMPayload
 */
export class DefaultObjectEzsignfoldertypeCreateObjectV1ResponseMPayload extends DefaultObject {
   a_pkiEzsignfoldertypeID:Array<number> = []
}
