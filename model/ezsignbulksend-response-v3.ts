 ...
 */
export interface EzsignbulksendResponseV3 {
    /**
...
/**
 * @export 
 * A EzsignbulksendResponseV3 Data Object with automatic temporary default value
 * Use this object only for create an empty data object to assign a response from server
 * @class DataObjectEzsignbulksendResponseV3
 */
export class DataObjectEzsignbulksendResponseV3 {
...
/**
 * @export 
 * A EzsignbulksendResponseV3 Validation Object
 * @class ValidationObjectEzsignbulksendResponseV3
 */
export class ValidationObjectEzsignbulksendResponseV3 {
   pkiEzsignbulksendID = {
      type: 'integer',
      minimum: 0,
      required: true
