 ...
 * @export
 * @interface EzsigntemplatesignaturecustomdateResponse
 */
export interface EzsigntemplatesignaturecustomdateResponse {
    /**
     * The unique ID of the Ezsigntemplatesignaturecustomdate
     * @type {number}
     * @memberof EzsigntemplatesignaturecustomdateResponse
     */
