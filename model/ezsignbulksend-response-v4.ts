 ...
 */
export interface EzsignbulksendResponseV4 {
    /**
...
/**
 * @export 
 * A EzsignbulksendResponseV4 Data Object with automatic temporary default value
 * Use this object only for create an empty data object to assign a response from server
 * @class DataObjectEzsignbulksendResponseV4
 */
export class DataObjectEzsignbulksendResponseV4 {
...
/**
 * @export 
 * A EzsignbulksendResponseV4 Validation Object
 * @class ValidationObjectEzsignbulksendResponseV4
 */
export class ValidationObjectEzsignbulksendResponseV4 {
   pkiEzsignbulksendID = {
      type: 'integer',
      minimum: 0,
      required: true
