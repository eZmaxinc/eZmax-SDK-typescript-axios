...
/**
 * A WebsiteRequest Object with automatic temp default value
 * Use this object only for create an empty object to assign a response from server
 * @export 
 * @class DefaultObjectWebsiteRequest
 */
export class DefaultObjectWebsiteRequest extends DefaultObject {
