...
/**
 * @export 
 * A EzsignformfieldgroupsignerResponseCompound Object with automatic temp default value
 * Use this object only for create an empty object to assign a response from server
 * @class DefaultObjectEzsignformfieldgroupsignerResponseCompound
 */
export class DefaultObjectEzsignformfieldgroupsignerResponseCompound extends DefaultObject {
