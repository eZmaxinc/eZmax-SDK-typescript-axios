...
/**
 * @type EzsigntemplatesignaturecustomdateResponseCompoundV2
 * An Ezsigntemplatesignaturecustomdate Object and children to create a complete structure
 * @export
 */
/*export type EzsigntemplatesignaturecustomdateResponseCompoundV2 = EzsigntemplatesignaturecustomdateResponseV2;*/
export interface EzsigntemplatesignaturecustomdateResponseCompoundV2 {
    /**
     * The unique ID of the Ezsigntemplatesignaturecustomdate
     * @type {number}
     * @memberof EzsigntemplatesignaturecustomdateResponseCompoundV2
     */
...
/**
 * @export 
 * A EzsigntemplatesignaturecustomdateResponseCompoundV2 Data Object with automatic temporary default value
 * Use this object only for create an empty data object to assign a response from server
 * @class DataObjectEzsigntemplatesignaturecustomdateResponseCompoundV2
 */
export class DataObjectEzsigntemplatesignaturecustomdateResponseCompoundV2 {
...
/**
 * @export 
 * A EzsigntemplatesignaturecustomdateResponseCompoundV2 Validation Object
 * @class ValidationObjectEzsigntemplatesignaturecustomdateResponseCompoundV2
 */
export class ValidationObjectEzsigntemplatesignaturecustomdateResponseCompoundV2 {
