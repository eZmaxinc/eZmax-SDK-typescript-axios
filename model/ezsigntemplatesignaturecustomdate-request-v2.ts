 ...
 * @export
 * @interface EzsigntemplatesignaturecustomdateRequestV2
 */
export interface EzsigntemplatesignaturecustomdateRequestV2 {
    /**
     * The unique ID of the Ezsigntemplatesignaturecustomdate
     * @type {number}
     * @memberof EzsigntemplatesignaturecustomdateRequestV2
     */
...
/**
 * @export 
 * A EzsigntemplatesignaturecustomdateRequestV2 Data Object with automatic temporary default value
 * Use this object only for create an empty data object to assign a response from server
 * @class DataObjectEzsigntemplatesignaturecustomdateRequestV2
 */
export class DataObjectEzsigntemplatesignaturecustomdateRequestV2 {
...
/**
 * @export 
 * A EzsigntemplatesignaturecustomdateRequestV2 Validation Object
 * @class ValidationObjectEzsigntemplatesignaturecustomdateRequestV2
 */
export class ValidationObjectEzsigntemplatesignaturecustomdateRequestV2 {
