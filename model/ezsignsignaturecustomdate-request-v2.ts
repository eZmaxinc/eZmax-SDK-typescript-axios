 ...
 * @export
 * @interface EzsignsignaturecustomdateRequestV2
 */
export interface EzsignsignaturecustomdateRequestV2 {
    /**
     * The unique ID of the Ezsignsignaturecustomdate
     * @type {number}
     * @memberof EzsignsignaturecustomdateRequestV2
     */
...
/**
 * @export 
 * A EzsignsignaturecustomdateRequestV2 Data Object with automatic temporary default value
 * Use this object only for create an empty data object to assign a response from server
 * @class DataObjectEzsignsignaturecustomdateRequestV2
 */
export class DataObjectEzsignsignaturecustomdateRequestV2 {
...
/**
 * @export 
 * A EzsignsignaturecustomdateRequestV2 Validation Object
 * @class ValidationObjectEzsignsignaturecustomdateRequestV2
 */
export class ValidationObjectEzsignsignaturecustomdateRequestV2 {
