 ...
 * @export
 * @interface WebsocketResponseErrorV1MPayload
 */
export interface WebsocketResponseErrorV1MPayload {
    /**
...
/**
 * @export 
 * A WebsocketResponseErrorV1MPayload Data Object with automatic temporary default value
 * Use this object only for create an empty data object to assign a response from server
 * @class DataObjectWebsocketResponseErrorV1MPayload
 */
export class DataObjectWebsocketResponseErrorV1MPayload {
   sErrorMessage:string = ''
...
/**
 * @export 
 * A WebsocketResponseErrorV1MPayload Validation Object
 * @class ValidationObjectWebsocketResponseErrorV1MPayload
 */
