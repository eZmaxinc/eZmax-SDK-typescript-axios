...
```typescript
import { EzsigntemplatepackagesignermembershipRequest } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplatepackagesignermembershipRequest = {
