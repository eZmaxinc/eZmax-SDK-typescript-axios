...
**mPayload** | [**AgentGetAutocompleteV2ResponseMPayload**](AgentGetAutocompleteV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { AgentGetAutocompleteV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: AgentGetAutocompleteV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
