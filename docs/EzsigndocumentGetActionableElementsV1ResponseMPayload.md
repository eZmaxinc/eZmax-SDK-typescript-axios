...
```typescript
import { EzsigndocumentGetActionableElementsV1ResponseMPayload } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigndocumentGetActionableElementsV1ResponseMPayload = {
