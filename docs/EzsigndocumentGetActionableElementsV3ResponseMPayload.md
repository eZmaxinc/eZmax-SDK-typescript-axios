...
```typescript
import { EzsigndocumentGetActionableElementsV3ResponseMPayload } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigndocumentGetActionableElementsV3ResponseMPayload = {
