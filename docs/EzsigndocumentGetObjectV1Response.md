...
**mPayload** | [**EzsigndocumentGetObjectV1ResponseMPayload**](EzsigndocumentGetObjectV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsigndocumentGetObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigndocumentGetObjectV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
