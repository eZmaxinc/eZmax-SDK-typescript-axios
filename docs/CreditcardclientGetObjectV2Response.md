...
**mPayload** | [**CreditcardclientGetObjectV2ResponseMPayload**](CreditcardclientGetObjectV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { CreditcardclientGetObjectV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: CreditcardclientGetObjectV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
