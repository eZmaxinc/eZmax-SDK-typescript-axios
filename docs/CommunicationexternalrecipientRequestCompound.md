...
```typescript
import { CommunicationexternalrecipientRequestCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: CommunicationexternalrecipientRequestCompound = {
