...
------------ | ------------- | ------------- | -------------
**pkiEzsigntemplateelementdependencyID** | **number** | The unique ID of the Ezsigntemplateelementdependency | [default to undefined]
**fkiEzsigntemplateformfieldID** | **number** | The unique ID of the Ezsigntemplateformfield | [optional] [default to undefined]
**fkiEzsigntemplatesignatureID** | **number** | The unique ID of the Ezsigntemplatesignature | [optional] [default to undefined]
...
```typescript
import { EzsigntemplateelementdependencyResponseCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplateelementdependencyResponseCompound = {
