...
**mPayload** | [**EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload**](EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsignbulksendGetEzsignsignaturesAutomaticV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignbulksendGetEzsignsignaturesAutomaticV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
