...
**mPayload** | [**EzsigndocumentGetEzsignannotationsV1ResponseMPayload**](EzsigndocumentGetEzsignannotationsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsigndocumentGetEzsignannotationsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigndocumentGetEzsignannotationsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
