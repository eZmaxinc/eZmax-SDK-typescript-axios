...
**mPayload** | [**EzsignfolderGetCommunicationCountV1ResponseMPayload**](EzsignfolderGetCommunicationCountV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsignfolderGetCommunicationCountV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignfolderGetCommunicationCountV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
