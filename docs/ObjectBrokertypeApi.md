...
|------------- | ------------- | -------------|
|[**brokertypeGetAutocompleteV2**](#brokertypegetautocompletev2) | **GET** /2/object/brokertype/getAutocomplete/{sSelector} | Retrieve Brokertypes and IDs|

# **brokertypeGetAutocompleteV2**
> BrokertypeGetAutocompleteV2Response brokertypeGetAutocompleteV2()
...
const apiInstance = new ObjectBrokertypeApi(configuration);

let sSelector: 'All'; //The type of Brokertypes to return (default to undefined)
...
const { status, data } = await apiInstance.brokertypeGetAutocompleteV2(
    sSelector,
    eFilterActive,
    sQuery,
    acceptLanguage
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;All&#39;**]**Array<&#39;All&#39;>** | The type of Brokertypes to return | defaults to undefined|
