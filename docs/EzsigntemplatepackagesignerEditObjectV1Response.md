...
```typescript
import { EzsigntemplatepackagesignerEditObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplatepackagesignerEditObjectV1Response = {
    objDebugPayload,
    objDebug,
};
```
