...
**mPayload** | [**ElectronicfundstransferGetCommunicationCountV1ResponseMPayload**](ElectronicfundstransferGetCommunicationCountV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { ElectronicfundstransferGetCommunicationCountV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: ElectronicfundstransferGetCommunicationCountV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
