...
|------------- | ------------- | -------------|
|[**franchisebrokerGetAutocompleteV2**](#franchisebrokergetautocompletev2) | **GET** /2/object/franchisebroker/getAutocomplete/{sSelector} | Retrieve Franchisebrokers and IDs|

# **franchisebrokerGetAutocompleteV2**
> FranchisebrokerGetAutocompleteV2Response franchisebrokerGetAutocompleteV2()
...
const apiInstance = new ObjectFranchisebrokerApi(configuration);

let sSelector: 'All'; //The type of Franchisebrokers to return (default to undefined)
...
const { status, data } = await apiInstance.franchisebrokerGetAutocompleteV2(
    sSelector,
    eFilterActive,
    sQuery,
    acceptLanguage
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;All&#39;**]**Array<&#39;All&#39;>** | The type of Franchisebrokers to return | defaults to undefined|
