...
|------------- | ------------- | -------------|
|[**userlogintypeGetAutocompleteV2**](#userlogintypegetautocompletev2) | **GET** /2/object/userlogintype/getAutocomplete/{sSelector} | Retrieve Userlogintypes and IDs|

# **userlogintypeGetAutocompleteV2**
> UserlogintypeGetAutocompleteV2Response userlogintypeGetAutocompleteV2()
...
const apiInstance = new ObjectUserlogintypeApi(configuration);

let sSelector: 'All' | 'Ezsignfoldertype' | 'EzsignfoldertypeReassign' | 'Ezsigntemplatepublic'; //The type of Userlogintypes to return (default to undefined)
...
const { status, data } = await apiInstance.userlogintypeGetAutocompleteV2(
    sSelector,
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;All&#39; | &#39;Ezsignfoldertype&#39; | &#39;EzsignfoldertypeReassign&#39; | &#39;Ezsigntemplatepublic&#39;**]**Array<&#39;All&#39; &#124; &#39;Ezsignfoldertype&#39; &#124; &#39;EzsignfoldertypeReassign&#39; &#124; &#39;Ezsigntemplatepublic&#39;>** | The type of Userlogintypes to return | defaults to undefined|
