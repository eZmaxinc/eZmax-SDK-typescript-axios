...
**eEzsignfolderSendreminderfrequency** | [**FieldEEzsignfolderSendreminderfrequency**](FieldEEzsignfolderSendreminderfrequency.md) |  | [default to undefined]
...
```typescript
import { EzsignfolderRequestCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignfolderRequestCompound = {
    pkiEzsignfolderID,
