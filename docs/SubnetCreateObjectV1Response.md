...
**mPayload** | [**SubnetCreateObjectV1ResponseMPayload**](SubnetCreateObjectV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { SubnetCreateObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: SubnetCreateObjectV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
