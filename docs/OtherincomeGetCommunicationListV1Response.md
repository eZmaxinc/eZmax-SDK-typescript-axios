...
**mPayload** | [**OtherincomeGetCommunicationListV1ResponseMPayload**](OtherincomeGetCommunicationListV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { OtherincomeGetCommunicationListV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: OtherincomeGetCommunicationListV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
