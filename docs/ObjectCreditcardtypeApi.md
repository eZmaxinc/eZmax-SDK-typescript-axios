...
|------------- | ------------- | -------------|
|[**creditcardtypeGetAutocompleteV2**](#creditcardtypegetautocompletev2) | **GET** /2/object/creditcardtype/getAutocomplete/{sSelector} | Retrieve Creditcardtypes and IDs|

# **creditcardtypeGetAutocompleteV2**
> CreditcardtypeGetAutocompleteV2Response creditcardtypeGetAutocompleteV2()
...
const apiInstance = new ObjectCreditcardtypeApi(configuration);

let sSelector: 'All'; //The type of Creditcardtypes to return (default to undefined)
...
const { status, data } = await apiInstance.creditcardtypeGetAutocompleteV2(
    sSelector,
    eFilterActive,
    sQuery,
    acceptLanguage
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;All&#39;**]**Array<&#39;All&#39;>** | The type of Creditcardtypes to return | defaults to undefined|
