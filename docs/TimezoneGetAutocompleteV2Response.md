...
**mPayload** | [**TimezoneGetAutocompleteV2ResponseMPayload**](TimezoneGetAutocompleteV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { TimezoneGetAutocompleteV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: TimezoneGetAutocompleteV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
