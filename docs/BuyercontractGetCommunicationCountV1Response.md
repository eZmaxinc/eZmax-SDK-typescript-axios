...
**mPayload** | [**BuyercontractGetCommunicationCountV1ResponseMPayload**](BuyercontractGetCommunicationCountV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { BuyercontractGetCommunicationCountV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: BuyercontractGetCommunicationCountV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
