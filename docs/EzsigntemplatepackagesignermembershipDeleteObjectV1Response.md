...
**mPayload** | [**EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload**](EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsigntemplatepackagesignermembershipDeleteObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplatepackagesignermembershipDeleteObjectV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
