...
**mPayload** | [**EzsignfolderGetActionableElementsForSignerV1ResponseMPayload**](EzsignfolderGetActionableElementsForSignerV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsignfolderGetActionableElementsForSignerV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignfolderGetActionableElementsForSignerV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
