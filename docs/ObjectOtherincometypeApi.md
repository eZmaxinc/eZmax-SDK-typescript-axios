...
|------------- | ------------- | -------------|
|[**otherincometypeGetAutocompleteV2**](#otherincometypegetautocompletev2) | **GET** /2/object/otherincometype/getAutocomplete/{sSelector} | Retrieve Otherincometypes and IDs|

# **otherincometypeGetAutocompleteV2**
> OtherincometypeGetAutocompleteV2Response otherincometypeGetAutocompleteV2()
...
const apiInstance = new ObjectOtherincometypeApi(configuration);

let sSelector: 'All'; //The type of Otherincometypes to return (default to undefined)
...
const { status, data } = await apiInstance.otherincometypeGetAutocompleteV2(
    sSelector,
    eFilterActive,
    sQuery,
    acceptLanguage
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;All&#39;**]**Array<&#39;All&#39;>** | The type of Otherincometypes to return | defaults to undefined|
