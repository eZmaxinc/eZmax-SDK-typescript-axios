...
**mPayload** | [**PdfalevelGetAutocompleteV2ResponseMPayload**](PdfalevelGetAutocompleteV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { PdfalevelGetAutocompleteV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: PdfalevelGetAutocompleteV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
