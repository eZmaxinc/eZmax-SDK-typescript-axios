...
**a_objEzmaxmaillinglist** | [**Array&lt;EzmaxmaillinglistListElement&gt;**](EzmaxmaillinglistListElement.md) |  | [default to undefined]

## Example

```typescript
import { EzmaxmaillinglistGetListV1ResponseMPayload } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzmaxmaillinglistGetListV1ResponseMPayload = {
    iRowReturned,
    iRowFiltered,
