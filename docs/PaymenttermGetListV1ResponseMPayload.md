...
**a_objPaymentterm** | [**Array&lt;PaymenttermListElement&gt;**](PaymenttermListElement.md) |  | [default to undefined]

## Example

```typescript
import { PaymenttermGetListV1ResponseMPayload } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: PaymenttermGetListV1ResponseMPayload = {
    iRowReturned,
    iRowFiltered,
    a_objPaymentterm,
};
