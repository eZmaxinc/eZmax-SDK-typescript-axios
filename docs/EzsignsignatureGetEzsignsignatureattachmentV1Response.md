...
**mPayload** | [**EzsignsignatureGetEzsignsignatureattachmentV1ResponseMPayload**](EzsignsignatureGetEzsignsignatureattachmentV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsignsignatureGetEzsignsignatureattachmentV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignsignatureGetEzsignsignatureattachmentV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
