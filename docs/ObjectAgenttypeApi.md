...
|------------- | ------------- | -------------|
|[**agenttypeGetAutocompleteV2**](#agenttypegetautocompletev2) | **GET** /2/object/agenttype/getAutocomplete/{sSelector} | Retrieve Agenttypes and IDs|

# **agenttypeGetAutocompleteV2**
> AgenttypeGetAutocompleteV2Response agenttypeGetAutocompleteV2()
...
const apiInstance = new ObjectAgenttypeApi(configuration);

let sSelector: 'All'; //The type of Agenttypes to return (default to undefined)
...
const { status, data } = await apiInstance.agenttypeGetAutocompleteV2(
    sSelector,
    eFilterActive,
    sQuery,
    acceptLanguage
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;All&#39;**]**Array<&#39;All&#39;>** | The type of Agenttypes to return | defaults to undefined|
