...
```typescript
import { EzsigntemplateannotationEditObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplateannotationEditObjectV1Response = {
    objDebugPayload,
    objDebug,
};
```
