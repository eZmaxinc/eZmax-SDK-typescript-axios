...
**mPayload** | [**DomainGetAutocompleteV2ResponseMPayload**](DomainGetAutocompleteV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { DomainGetAutocompleteV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: DomainGetAutocompleteV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
