...
**mPayload** | [**InscriptionchecklistGetAutocompleteV2ResponseMPayload**](InscriptionchecklistGetAutocompleteV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { InscriptionchecklistGetAutocompleteV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: InscriptionchecklistGetAutocompleteV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
