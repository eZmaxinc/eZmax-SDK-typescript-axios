...
**mPayload** | [**EmployeeGetAttachmentsV1ResponseMPayload**](EmployeeGetAttachmentsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EmployeeGetAttachmentsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EmployeeGetAttachmentsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
