...
------------ | ------------- | ------------- | -------------
**pkiEzsignsignerID** | **number** | The unique ID of the Ezsignsigner | [default to undefined]
...
**objContact** | [**EzsignsignerResponseCompoundContact**](EzsignsignerResponseCompoundContact.md) |  | [default to undefined]

## Example

```typescript
import { EzsignsignerResponseCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignsignerResponseCompound = {
    pkiEzsignsignerID,
    fkiTaxassignmentID,
    fkiSecretquestionID,
    fkiUserlogintypeID,
