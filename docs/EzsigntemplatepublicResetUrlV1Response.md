...
**mPayload** | [**EzsigntemplatepublicResetUrlV1ResponseMPayload**](EzsigntemplatepublicResetUrlV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsigntemplatepublicResetUrlV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplatepublicResetUrlV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
