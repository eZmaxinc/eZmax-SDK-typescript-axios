...
```typescript
import { EzsignbulksendsignermappingDeleteObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignbulksendsignermappingDeleteObjectV1Response = {
    objDebugPayload,
    objDebug,
};
```
