...
```typescript
import { InscriptionnotauthenticatedconditionResponseCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: InscriptionnotauthenticatedconditionResponseCompound = {
