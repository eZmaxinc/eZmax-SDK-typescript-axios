...
**mPayload** | [**UserCreateEzsignuserV1ResponseMPayload**](UserCreateEzsignuserV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { UserCreateEzsignuserV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: UserCreateEzsignuserV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
