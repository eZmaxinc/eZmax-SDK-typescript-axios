...
**mPayload** | [**UserGetObjectV2ResponseMPayload**](UserGetObjectV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { UserGetObjectV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: UserGetObjectV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
