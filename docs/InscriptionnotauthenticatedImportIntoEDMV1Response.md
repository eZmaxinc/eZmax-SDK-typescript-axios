...
**mPayload** | [**InscriptionnotauthenticatedImportIntoEDMV1ResponseMPayload**](InscriptionnotauthenticatedImportIntoEDMV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { InscriptionnotauthenticatedImportIntoEDMV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: InscriptionnotauthenticatedImportIntoEDMV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
