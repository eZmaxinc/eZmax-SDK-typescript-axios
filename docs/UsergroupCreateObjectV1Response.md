...
**mPayload** | [**UsergroupCreateObjectV1ResponseMPayload**](UsergroupCreateObjectV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { UsergroupCreateObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: UsergroupCreateObjectV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
