...
**iEzsigndocumentSteptotal** | **number** | The total number of steps | [default to undefined]
**iEzsigndocumentStepcurrent** | **number** | The current step | [default to undefined]
**a_objEzsignfoldersignerassociationstatus** | [**Array&lt;CustomEzsignfoldersignerassociationstatusResponseV3&gt;**](CustomEzsignfoldersignerassociationstatusResponseV3.md) |  | [default to undefined]
...
```typescript
import { EzsigndocumentResponseCompoundV3 } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigndocumentResponseCompoundV3 = {
    pkiEzsigndocumentID,
    fkiEzsignfolderID,
