...
**mPayload** | [**RejectedoffertopurchaseGetCommunicationrecipientsV1ResponseMPayload**](RejectedoffertopurchaseGetCommunicationrecipientsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { RejectedoffertopurchaseGetCommunicationrecipientsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: RejectedoffertopurchaseGetCommunicationrecipientsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
