...
**mPayload** | [**VariableexpenseGetObjectV2ResponseMPayload**](VariableexpenseGetObjectV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { VariableexpenseGetObjectV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: VariableexpenseGetObjectV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
