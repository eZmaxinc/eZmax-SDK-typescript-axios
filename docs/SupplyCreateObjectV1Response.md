...
**mPayload** | [**SupplyCreateObjectV1ResponseMPayload**](SupplyCreateObjectV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { SupplyCreateObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: SupplyCreateObjectV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
