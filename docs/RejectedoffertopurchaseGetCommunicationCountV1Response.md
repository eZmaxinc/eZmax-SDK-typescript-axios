...
**mPayload** | [**RejectedoffertopurchaseGetCommunicationCountV1ResponseMPayload**](RejectedoffertopurchaseGetCommunicationCountV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { RejectedoffertopurchaseGetCommunicationCountV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: RejectedoffertopurchaseGetCommunicationCountV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
