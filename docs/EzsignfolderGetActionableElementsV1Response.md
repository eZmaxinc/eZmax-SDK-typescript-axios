...
**mPayload** | [**EzsignfolderGetActionableElementsV1ResponseMPayload**](EzsignfolderGetActionableElementsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsignfolderGetActionableElementsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignfolderGetActionableElementsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
