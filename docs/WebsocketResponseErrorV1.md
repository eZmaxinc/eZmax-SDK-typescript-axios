...
**mPayload** | [**WebsocketResponseErrorV1MPayload**](WebsocketResponseErrorV1MPayload.md) |  | [default to undefined]

## Example

```typescript
import { WebsocketResponseErrorV1 } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: WebsocketResponseErrorV1 = {
