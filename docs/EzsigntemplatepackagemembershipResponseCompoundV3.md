...
**objEzsigntemplate** | [**EzsigntemplateResponseCompoundV4**](EzsigntemplateResponseCompoundV4.md) |  | [default to undefined]
...
```typescript
import { EzsigntemplatepackagemembershipResponseCompoundV3 } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplatepackagemembershipResponseCompoundV3 = {
