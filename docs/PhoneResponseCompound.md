...
------------ | ------------- | ------------- | -------------
**pkiPhoneID** | **number** | The unique ID of the Phone. | [default to undefined]
...
**bPhoneInternational** | **boolean** | Indicate the phone number is an international phone number. | [optional] [default to undefined]

## Example

```typescript
import { PhoneResponseCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: PhoneResponseCompound = {
    pkiPhoneID,
    fkiPhonetypeID,
    ePhoneType,
    sPhoneE164,
