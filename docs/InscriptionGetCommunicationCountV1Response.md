...
**mPayload** | [**InscriptionGetCommunicationCountV1ResponseMPayload**](InscriptionGetCommunicationCountV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { InscriptionGetCommunicationCountV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: InscriptionGetCommunicationCountV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
