...
**a_objUsergroupexternal** | [**Array&lt;UsergroupexternalListElement&gt;**](UsergroupexternalListElement.md) |  | [default to undefined]

## Example

```typescript
import { UsergroupexternalGetListV1ResponseMPayload } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: UsergroupexternalGetListV1ResponseMPayload = {
    iRowReturned,
    iRowFiltered,
