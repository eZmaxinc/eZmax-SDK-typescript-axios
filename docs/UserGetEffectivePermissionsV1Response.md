...
**mPayload** | [**UserGetEffectivePermissionsV1ResponseMPayload**](UserGetEffectivePermissionsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { UserGetEffectivePermissionsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: UserGetEffectivePermissionsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
