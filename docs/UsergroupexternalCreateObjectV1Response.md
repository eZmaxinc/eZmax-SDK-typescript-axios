...
**mPayload** | [**UsergroupexternalCreateObjectV1ResponseMPayload**](UsergroupexternalCreateObjectV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { UsergroupexternalCreateObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: UsergroupexternalCreateObjectV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
