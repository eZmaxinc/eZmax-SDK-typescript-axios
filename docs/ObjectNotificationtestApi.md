...
|------------- | ------------- | -------------|
|[**notificationtestGetElementsV1**](#notificationtestgetelementsv1) | **GET** /1/object/notificationtest/{pkiNotificationtestID}/getElements | Retrieve an existing Notificationtest\&#39;s Elements|
...
> NotificationtestGetElementsV1Response notificationtestGetElementsV1()
...
const { status, data } = await apiInstance.notificationtestGetElementsV1(
