...
**mPayload** | [**EzsignbulksendGetObjectV2ResponseMPayload**](EzsignbulksendGetObjectV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsignbulksendGetObjectV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignbulksendGetObjectV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
