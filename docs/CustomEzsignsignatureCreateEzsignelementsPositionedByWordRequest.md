...
```typescript
import { CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest = {
