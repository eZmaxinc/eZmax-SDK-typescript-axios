...
**mPayload** | [**CurrencyGetAutocompleteV2ResponseMPayload**](CurrencyGetAutocompleteV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { CurrencyGetAutocompleteV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: CurrencyGetAutocompleteV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
