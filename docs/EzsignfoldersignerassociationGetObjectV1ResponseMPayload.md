...
```typescript
import { EzsignfoldersignerassociationGetObjectV1ResponseMPayload } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignfoldersignerassociationGetObjectV1ResponseMPayload = {
