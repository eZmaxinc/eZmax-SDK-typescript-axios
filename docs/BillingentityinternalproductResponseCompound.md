...
```typescript
import { BillingentityinternalproductResponseCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: BillingentityinternalproductResponseCompound = {
