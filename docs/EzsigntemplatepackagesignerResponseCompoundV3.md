...
```typescript
import { EzsigntemplatepackagesignerResponseCompoundV3 } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplatepackagesignerResponseCompoundV3 = {
