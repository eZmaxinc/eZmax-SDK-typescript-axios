...
**mPayload** | [**WebhookGetObjectV2ResponseMPayload**](WebhookGetObjectV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { WebhookGetObjectV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: WebhookGetObjectV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
