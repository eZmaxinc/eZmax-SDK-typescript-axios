...
**mPayload** | [**EzsigntemplatedocumentGetObjectV2ResponseMPayload**](EzsigntemplatedocumentGetObjectV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsigntemplatedocumentGetObjectV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplatedocumentGetObjectV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
