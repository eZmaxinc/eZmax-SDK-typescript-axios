...
**mPayload** | [**CorsCreateObjectV1ResponseMPayload**](CorsCreateObjectV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { CorsCreateObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: CorsCreateObjectV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
