...
**mPayload** | [**RejectedoffertopurchaseGetCommunicationsendersV1ResponseMPayload**](RejectedoffertopurchaseGetCommunicationsendersV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { RejectedoffertopurchaseGetCommunicationsendersV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: RejectedoffertopurchaseGetCommunicationsendersV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
