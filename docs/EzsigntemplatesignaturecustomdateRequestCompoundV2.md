...
```typescript
import { EzsigntemplatesignaturecustomdateRequestCompoundV2 } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplatesignaturecustomdateRequestCompoundV2 = {
