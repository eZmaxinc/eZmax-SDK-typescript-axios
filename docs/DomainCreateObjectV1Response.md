...
**mPayload** | [**DomainCreateObjectV1ResponseMPayload**](DomainCreateObjectV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { DomainCreateObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: DomainCreateObjectV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
