...
**mPayload** | [**OtherincomeGetCommunicationCountV1ResponseMPayload**](OtherincomeGetCommunicationCountV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { OtherincomeGetCommunicationCountV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: OtherincomeGetCommunicationCountV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
