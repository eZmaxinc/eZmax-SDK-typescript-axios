...
**mPayload** | [**EzsignsignatureCreateObjectV1ResponseMPayload**](EzsignsignatureCreateObjectV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsignsignatureCreateObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignsignatureCreateObjectV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
