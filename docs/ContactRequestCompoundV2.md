...
**objContactinformations** | [**ContactinformationsRequestCompoundV2**](ContactinformationsRequestCompoundV2.md) |  | [default to undefined]

## Example

```typescript
import { ContactRequestCompoundV2 } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: ContactRequestCompoundV2 = {
    fkiContacttitleID,
    fkiLanguageID,
    eContactType,
    sContactFirstname,
