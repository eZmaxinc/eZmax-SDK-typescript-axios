...
**mPayload** | [**LeadGetAttachmentsV1ResponseMPayload**](LeadGetAttachmentsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { LeadGetAttachmentsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: LeadGetAttachmentsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
