...
**mPayload** | [**EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload**](EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsignfolderGetEzsignsignaturesAutomaticV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignfolderGetEzsignsignaturesAutomaticV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
