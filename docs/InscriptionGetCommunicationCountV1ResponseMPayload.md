...
```typescript
import { InscriptionGetCommunicationCountV1ResponseMPayload } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: InscriptionGetCommunicationCountV1ResponseMPayload = {
    iCommunicationCount,
};
```
