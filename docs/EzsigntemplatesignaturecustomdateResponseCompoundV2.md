...
------------ | ------------- | ------------- | -------------
**pkiEzsigntemplatesignaturecustomdateID** | **number** | The unique ID of the Ezsigntemplatesignaturecustomdate | [default to undefined]
...
```typescript
import { EzsigntemplatesignaturecustomdateResponseCompoundV2 } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplatesignaturecustomdateResponseCompoundV2 = {
