...
------------ | ------------- | ------------- | -------------
**pkiEzsignannotationID** | **number** | The unique ID of the Ezsignannotation | [optional] [default to undefined]
...
```typescript
import { EzsignannotationRequestCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignannotationRequestCompound = {
