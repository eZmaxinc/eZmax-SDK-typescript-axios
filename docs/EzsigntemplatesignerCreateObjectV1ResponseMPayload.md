...
```typescript
import { EzsigntemplatesignerCreateObjectV1ResponseMPayload } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplatesignerCreateObjectV1ResponseMPayload = {
