...
```typescript
import { EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload = {
