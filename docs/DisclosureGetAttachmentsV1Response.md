...
**mPayload** | [**DisclosureGetAttachmentsV1ResponseMPayload**](DisclosureGetAttachmentsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { DisclosureGetAttachmentsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: DisclosureGetAttachmentsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
