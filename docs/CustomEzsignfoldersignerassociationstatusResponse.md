...
```typescript
import { CustomEzsignfoldersignerassociationstatusResponse } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: CustomEzsignfoldersignerassociationstatusResponse = {
