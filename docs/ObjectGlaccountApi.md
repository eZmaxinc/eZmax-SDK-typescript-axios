...
|------------- | ------------- | -------------|
|[**glaccountGetAutocompleteV2**](#glaccountgetautocompletev2) | **GET** /2/object/glaccount/getAutocomplete/{sSelector} | Retrieve Glaccounts and IDs|

# **glaccountGetAutocompleteV2**
> GlaccountGetAutocompleteV2Response glaccountGetAutocompleteV2()
...
const apiInstance = new ObjectGlaccountApi(configuration);

let sSelector: 'All' | 'Supply'; //The type of Glaccounts to return (default to undefined)
...
const { status, data } = await apiInstance.glaccountGetAutocompleteV2(
    sSelector,
    eFilterActive,
    sQuery,
    acceptLanguage
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;All&#39; | &#39;Supply&#39;**]**Array<&#39;All&#39; &#124; &#39;Supply&#39;>** | The type of Glaccounts to return | defaults to undefined|
