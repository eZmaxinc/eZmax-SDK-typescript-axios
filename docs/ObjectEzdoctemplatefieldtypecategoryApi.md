...
|------------- | ------------- | -------------|
|[**ezdoctemplatefieldtypecategoryGetAutocompleteV2**](#ezdoctemplatefieldtypecategorygetautocompletev2) | **GET** /2/object/ezdoctemplatefieldtypecategory/getAutocomplete/{sSelector} | Retrieve Ezdoctemplatefieldtypecategorys and IDs|

# **ezdoctemplatefieldtypecategoryGetAutocompleteV2**
> EzdoctemplatefieldtypecategoryGetAutocompleteV2Response ezdoctemplatefieldtypecategoryGetAutocompleteV2()
...
const apiInstance = new ObjectEzdoctemplatefieldtypecategoryApi(configuration);

let sSelector: 'All'; //The type of Ezdoctemplatefieldtypecategorys to return (default to undefined)
...
const { status, data } = await apiInstance.ezdoctemplatefieldtypecategoryGetAutocompleteV2(
    sSelector,
    eFilterActive,
    sQuery,
    acceptLanguage
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;All&#39;**]**Array<&#39;All&#39;>** | The type of Ezdoctemplatefieldtypecategorys to return | defaults to undefined|
