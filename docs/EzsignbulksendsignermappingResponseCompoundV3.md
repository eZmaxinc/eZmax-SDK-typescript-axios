...
```typescript
import { EzsignbulksendsignermappingResponseCompoundV3 } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignbulksendsignermappingResponseCompoundV3 = {
