...
**mPayload** | [**CommissionadvanceGetAttachmentsV1ResponseMPayload**](CommissionadvanceGetAttachmentsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { CommissionadvanceGetAttachmentsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: CommissionadvanceGetAttachmentsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
