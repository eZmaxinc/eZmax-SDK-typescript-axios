...
**a_objDnsrecord** | [**Array&lt;CustomDnsrecordResponse&gt;**](CustomDnsrecordResponse.md) |  | [default to undefined]

## Example

```typescript
import { DomainResponseCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: DomainResponseCompound = {
    pkiDomainID,
    sDomainName,
    bDomainValiddkim,
