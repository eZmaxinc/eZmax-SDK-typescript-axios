...
**mPayload** | [**EzsigntemplatedocumentGetEzsigntemplatesignaturesV2ResponseMPayload**](EzsigntemplatedocumentGetEzsigntemplatesignaturesV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsigntemplatedocumentGetEzsigntemplatesignaturesV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplatedocumentGetEzsigntemplatesignaturesV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
