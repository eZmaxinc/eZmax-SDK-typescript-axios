...
```typescript
import { EzsigntemplatesignaturepaymentdetailRequestCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplatesignaturepaymentdetailRequestCompound = {
