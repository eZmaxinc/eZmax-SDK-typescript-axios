...
**objEzsignsignature** | [**EzsignsignatureResponse**](EzsignsignatureResponse.md) |  | [default to undefined]

## Example

```typescript
import { WebhookEzsignSignatureSigned } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: WebhookEzsignSignatureSigned = {
    objWebhook,
    a_objAttempt,
    objEzsignsignature,
};
