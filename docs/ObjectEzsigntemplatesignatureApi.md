...
|[**ezsigntemplatesignatureEditObjectV2**](#ezsigntemplatesignatureeditobjectv2) | **PUT** /2/object/ezsigntemplatesignature/{pkiEzsigntemplatesignatureID} | Edit an existing Ezsigntemplatesignature|
...
|[**ezsigntemplatesignatureGetObjectV3**](#ezsigntemplatesignaturegetobjectv3) | **GET** /3/object/ezsigntemplatesignature/{pkiEzsigntemplatesignatureID} | Retrieve an existing Ezsigntemplatesignature|
...
> EzsigntemplatesignatureEditObjectV2Response ezsigntemplatesignatureEditObjectV2(ezsigntemplatesignatureEditObjectV2Request)
...
let pkiEzsigntemplatesignatureID: number; // (default to undefined)
let ezsigntemplatesignatureEditObjectV2Request: EzsigntemplatesignatureEditObjectV2Request; //

const { status, data } = await apiInstance.ezsigntemplatesignatureEditObjectV2(
    pkiEzsigntemplatesignatureID,
    ezsigntemplatesignatureEditObjectV2Request
);
```
...
> EzsigntemplatesignatureGetObjectV3Response ezsigntemplatesignatureGetObjectV3()
...
const { status, data } = await apiInstance.ezsigntemplatesignatureGetObjectV3(
    pkiEzsigntemplatesignatureID
);
```
