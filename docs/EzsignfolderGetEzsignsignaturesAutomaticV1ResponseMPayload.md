...
```typescript
import { EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload = {
