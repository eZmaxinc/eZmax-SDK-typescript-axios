...
```typescript
import { EzsigntemplateformfieldgroupDeleteObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplateformfieldgroupDeleteObjectV1Response = {
    objDebugPayload,
    objDebug,
};
```
