...
|------------- | ------------- | -------------|
|[**countryGetAutocompleteV2**](#countrygetautocompletev2) | **GET** /2/object/country/getAutocomplete/{sSelector} | Retrieve Countries and IDs|

# **countryGetAutocompleteV2**
> CountryGetAutocompleteV2Response countryGetAutocompleteV2()
...
const apiInstance = new ObjectCountryApi(configuration);

let sSelector: 'All'; //The type of Countries to return (default to undefined)
...
const { status, data } = await apiInstance.countryGetAutocompleteV2(
    sSelector,
    eFilterActive,
    sQuery,
    acceptLanguage
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;All&#39;**]**Array<&#39;All&#39;>** | The type of Countries to return | defaults to undefined|
