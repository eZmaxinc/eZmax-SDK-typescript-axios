...
```typescript
import { EzsignsignatureResponseCompoundV3 } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignsignatureResponseCompoundV3 = {
