...
|------------- | ------------- | -------------|
|[**paymentmethodGetAutocompleteV2**](#paymentmethodgetautocompletev2) | **GET** /2/object/paymentmethod/getAutocomplete/{sSelector} | Retrieve Paymentmethods and IDs|

# **paymentmethodGetAutocompleteV2**
> PaymentmethodGetAutocompleteV2Response paymentmethodGetAutocompleteV2()
...
const apiInstance = new ObjectPaymentmethodApi(configuration);

let sSelector: 'All'; //The type of Paymentmethods to return (default to undefined)
...
const { status, data } = await apiInstance.paymentmethodGetAutocompleteV2(
    sSelector,
    eFilterActive,
    sQuery,
    acceptLanguage
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;All&#39;**]**Array<&#39;All&#39;>** | The type of Paymentmethods to return | defaults to undefined|
