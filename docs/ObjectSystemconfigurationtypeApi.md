...
|------------- | ------------- | -------------|
|[**systemconfigurationtypeGetAutocompleteV2**](#systemconfigurationtypegetautocompletev2) | **GET** /2/object/systemconfigurationtype/getAutocomplete/{sSelector} | Retrieve Systemconfigurationtype and IDs|

# **systemconfigurationtypeGetAutocompleteV2**
> SystemconfigurationtypeGetAutocompleteV2Response systemconfigurationtypeGetAutocompleteV2()
...
const apiInstance = new ObjectSystemconfigurationtypeApi(configuration);

let sSelector: 'All'; //The type of Systemconfigurationtype to return (default to undefined)
...
const { status, data } = await apiInstance.systemconfigurationtypeGetAutocompleteV2(
    sSelector,
    eFilterActive,
    sQuery,
    acceptLanguage
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;All&#39;**]**Array<&#39;All&#39;>** | The type of Systemconfigurationtype to return | defaults to undefined|
