...
```typescript
import { EzsignbulksenddocumentmappingDeleteObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignbulksenddocumentmappingDeleteObjectV1Response = {
    objDebugPayload,
    objDebug,
};
```
