...
**mPayload** | [**BuyercontractGetListV1ResponseMPayload**](BuyercontractGetListV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { BuyercontractGetListV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: BuyercontractGetListV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
