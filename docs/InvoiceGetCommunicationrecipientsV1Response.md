...
**mPayload** | [**InvoiceGetCommunicationrecipientsV1ResponseMPayload**](InvoiceGetCommunicationrecipientsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { InvoiceGetCommunicationrecipientsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: InvoiceGetCommunicationrecipientsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
