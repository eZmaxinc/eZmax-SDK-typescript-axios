...
**mPayload** | [**UserGetUsergroupexternalsV1ResponseMPayload**](UserGetUsergroupexternalsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { UserGetUsergroupexternalsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: UserGetUsergroupexternalsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
