...
------------ | ------------- | ------------- | -------------
**pkiEzsignsignaturecustomdateID** | **number** | The unique ID of the Ezsignsignaturecustomdate | [default to undefined]
...
```typescript
import { EzsignsignaturecustomdateResponseCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignsignaturecustomdateResponseCompound = {
