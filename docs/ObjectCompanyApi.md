...
|------------- | ------------- | -------------|
|[**companyGetAutocompleteV2**](#companygetautocompletev2) | **GET** /2/object/company/getAutocomplete/{sSelector} | Retrieve Companys and IDs|

# **companyGetAutocompleteV2**
> CompanyGetAutocompleteV2Response companyGetAutocompleteV2()
...
const apiInstance = new ObjectCompanyApi(configuration);

let sSelector: 'All'; //The type of Companys to return (default to undefined)
...
const { status, data } = await apiInstance.companyGetAutocompleteV2(
    sSelector,
    eFilterActive,
    sQuery,
    acceptLanguage
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;All&#39;**]**Array<&#39;All&#39;>** | The type of Companys to return | defaults to undefined|
