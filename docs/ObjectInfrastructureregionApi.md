...
|------------- | ------------- | -------------|
|[**infrastructureregionGetAutocompleteV2**](#infrastructureregiongetautocompletev2) | **GET** /2/object/infrastructureregion/getAutocomplete/{sSelector} | Retrieve Infrastructureregions and IDs|

# **infrastructureregionGetAutocompleteV2**
> InfrastructureregionGetAutocompleteV2Response infrastructureregionGetAutocompleteV2()
...
const apiInstance = new ObjectInfrastructureregionApi(configuration);

let sSelector: 'AWS' | 'Programmer'; //The type of Infrastructureregions  to return (default to undefined)
...
const { status, data } = await apiInstance.infrastructureregionGetAutocompleteV2(
    sSelector,
    eFilterActive,
    sQuery,
    acceptLanguage
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;AWS&#39; | &#39;Programmer&#39;**]**Array<&#39;AWS&#39; &#124; &#39;Programmer&#39;>** | The type of Infrastructureregions  to return | defaults to undefined|
