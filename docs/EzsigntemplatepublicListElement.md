...
**iEzsignfolder** | **number** | The total number of Ezsignfolders using the Ezsigntemplatepublic | [default to undefined]
**iEzsigndocument** | **number** | The total number of Ezsigndocuments using the Ezsigntemplatepublic | [default to undefined]
...
```typescript
import { EzsigntemplatepublicListElement } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplatepublicListElement = {
