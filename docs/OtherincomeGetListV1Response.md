...
**mPayload** | [**OtherincomeGetListV1ResponseMPayload**](OtherincomeGetListV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { OtherincomeGetListV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: OtherincomeGetListV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
