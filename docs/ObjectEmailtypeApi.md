...
|------------- | ------------- | -------------|
|[**emailtypeGetAutocompleteV2**](#emailtypegetautocompletev2) | **GET** /2/object/emailtype/getAutocomplete/{sSelector} | Retrieve Emailtypes and IDs|

# **emailtypeGetAutocompleteV2**
> EmailtypeGetAutocompleteV2Response emailtypeGetAutocompleteV2()
...
const apiInstance = new ObjectEmailtypeApi(configuration);

let sSelector: 'All'; //The type of Emailtypes to return (default to undefined)
...
const { status, data } = await apiInstance.emailtypeGetAutocompleteV2(
    sSelector,
    eFilterActive,
    sQuery,
    acceptLanguage
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;All&#39;**]**Array<&#39;All&#39;>** | The type of Emailtypes to return | defaults to undefined|
