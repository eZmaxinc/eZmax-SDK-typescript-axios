...
**mPayload** | [**ExternalbrokerImportIntoEDMV1ResponseMPayload**](ExternalbrokerImportIntoEDMV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { ExternalbrokerImportIntoEDMV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: ExternalbrokerImportIntoEDMV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
