...
**mPayload** | [**NotaryGetAttachmentsV1ResponseMPayload**](NotaryGetAttachmentsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { NotaryGetAttachmentsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: NotaryGetAttachmentsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
