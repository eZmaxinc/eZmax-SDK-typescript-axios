...
**mPayload** | [**BuyercontractGetCommunicationrecipientsV1ResponseMPayload**](BuyercontractGetCommunicationrecipientsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { BuyercontractGetCommunicationrecipientsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: BuyercontractGetCommunicationrecipientsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
