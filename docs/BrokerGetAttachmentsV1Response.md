...
**mPayload** | [**BrokerGetAttachmentsV1ResponseMPayload**](BrokerGetAttachmentsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { BrokerGetAttachmentsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: BrokerGetAttachmentsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
