...
**mPayload** | [**InscriptiontypeGetAutocompleteV2ResponseMPayload**](InscriptiontypeGetAutocompleteV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { InscriptiontypeGetAutocompleteV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: InscriptiontypeGetAutocompleteV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
