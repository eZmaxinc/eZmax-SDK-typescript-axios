...
**mPayload** | [**CreditcardclientGetListV1ResponseMPayload**](CreditcardclientGetListV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { CreditcardclientGetListV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: CreditcardclientGetListV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
