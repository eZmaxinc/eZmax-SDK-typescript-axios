...
**mPayload** | [**DomainGetObjectV2ResponseMPayload**](DomainGetObjectV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { DomainGetObjectV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: DomainGetObjectV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
