...
**mPayload** | [**PaymenttermCreateObjectV1ResponseMPayload**](PaymenttermCreateObjectV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { PaymenttermCreateObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: PaymenttermCreateObjectV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
