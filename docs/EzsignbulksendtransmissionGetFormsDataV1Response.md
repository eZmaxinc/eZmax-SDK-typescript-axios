...
**mPayload** | [**EzsignbulksendtransmissionGetFormsDataV1ResponseMPayload**](EzsignbulksendtransmissionGetFormsDataV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsignbulksendtransmissionGetFormsDataV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignbulksendtransmissionGetFormsDataV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
