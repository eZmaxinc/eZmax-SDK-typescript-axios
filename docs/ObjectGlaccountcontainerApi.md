...
|------------- | ------------- | -------------|
|[**glaccountcontainerGetAutocompleteV2**](#glaccountcontainergetautocompletev2) | **GET** /2/object/glaccountcontainer/getAutocomplete/{sSelector} | Retrieve Glaccountcontainers and IDs|

# **glaccountcontainerGetAutocompleteV2**
> GlaccountcontainerGetAutocompleteV2Response glaccountcontainerGetAutocompleteV2()
...
const apiInstance = new ObjectGlaccountcontainerApi(configuration);

let sSelector: 'All' | 'AllWithoutSubsidiary' | 'Supply'; //The type of Glaccountcontainers to return (default to undefined)
...
const { status, data } = await apiInstance.glaccountcontainerGetAutocompleteV2(
    sSelector,
    eFilterActive,
    sQuery,
    acceptLanguage
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;All&#39; | &#39;AllWithoutSubsidiary&#39; | &#39;Supply&#39;**]**Array<&#39;All&#39; &#124; &#39;AllWithoutSubsidiary&#39; &#124; &#39;Supply&#39;>** | The type of Glaccountcontainers to return | defaults to undefined|
