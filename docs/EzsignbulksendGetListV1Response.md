...
**mPayload** | [**EzsignbulksendGetListV1ResponseMPayload**](EzsignbulksendGetListV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsignbulksendGetListV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignbulksendGetListV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
