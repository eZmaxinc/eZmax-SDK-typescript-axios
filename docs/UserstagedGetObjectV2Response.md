...
**mPayload** | [**UserstagedGetObjectV2ResponseMPayload**](UserstagedGetObjectV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { UserstagedGetObjectV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: UserstagedGetObjectV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
