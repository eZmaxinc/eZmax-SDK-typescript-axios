...
------------ | ------------- | ------------- | -------------
**pkiEzsigntemplateformfieldID** | **number** | The unique ID of the Ezsigntemplateformfield | [optional] [default to undefined]
...
```typescript
import { EzsigntemplateformfieldRequestCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplateformfieldRequestCompound = {
