...
|------------- | ------------- | -------------|
|[**currencyGetAutocompleteV2**](#currencygetautocompletev2) | **GET** /2/object/currency/getAutocomplete/{sSelector} | Retrieve Currencies and IDs|

# **currencyGetAutocompleteV2**
> CurrencyGetAutocompleteV2Response currencyGetAutocompleteV2()
...
const apiInstance = new ObjectCurrencyApi(configuration);

let sSelector: 'All'; //The type of Currencies to return (default to undefined)
...
const { status, data } = await apiInstance.currencyGetAutocompleteV2(
    sSelector,
    eFilterActive,
    sQuery,
    acceptLanguage
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;All&#39;**]**Array<&#39;All&#39;>** | The type of Currencies to return | defaults to undefined|
