...
**mPayload** | [**SalaryGetAttachmentsV1ResponseMPayload**](SalaryGetAttachmentsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { SalaryGetAttachmentsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: SalaryGetAttachmentsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
