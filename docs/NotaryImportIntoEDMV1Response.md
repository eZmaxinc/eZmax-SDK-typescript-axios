...
**mPayload** | [**NotaryImportIntoEDMV1ResponseMPayload**](NotaryImportIntoEDMV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { NotaryImportIntoEDMV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: NotaryImportIntoEDMV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
