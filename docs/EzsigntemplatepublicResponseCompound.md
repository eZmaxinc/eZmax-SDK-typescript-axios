...
**a_objEzsignfolderezsigntemplatepublic** | [**Array&lt;CustomEzsignfolderezsigntemplatepublicResponse&gt;**](CustomEzsignfolderezsigntemplatepublicResponse.md) |  | [default to undefined]

## Example

```typescript
import { EzsigntemplatepublicResponseCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplatepublicResponseCompound = {
