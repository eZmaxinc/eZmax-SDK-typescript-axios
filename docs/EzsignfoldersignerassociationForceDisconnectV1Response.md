...
```typescript
import { EzsignfoldersignerassociationForceDisconnectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignfoldersignerassociationForceDisconnectV1Response = {
    objDebugPayload,
    objDebug,
};
```
