...
------------ | ------------- | ------------- | -------------
**pkiEzsigntemplateformfieldgroupsignerID** | **number** | The unique ID of the Ezsigntemplateformfieldgroupsigner | [optional] [default to undefined]
**fkiEzsigntemplatesignerID** | **number** | The unique ID of the Ezsigntemplatesigner | [default to undefined]

## Example

```typescript
import { EzsigntemplateformfieldgroupsignerRequestCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplateformfieldgroupsignerRequestCompound = {
