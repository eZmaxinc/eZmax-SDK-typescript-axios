...
**mPayload** | [**DiscussionGetObjectV2ResponseMPayload**](DiscussionGetObjectV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { DiscussionGetObjectV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: DiscussionGetObjectV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
