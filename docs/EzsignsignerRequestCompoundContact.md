...
**sPhoneNumber** | **string** |  | [optional] [default to undefined]
**sPhoneNumberCell** | **string** |  | [optional] [default to undefined]

## Example

```typescript
import { EzsignsignerRequestCompoundContact } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignsignerRequestCompoundContact = {
    sContactFirstname,
    sContactLastname,
    fkiLanguageID,
    sEmailAddress,
