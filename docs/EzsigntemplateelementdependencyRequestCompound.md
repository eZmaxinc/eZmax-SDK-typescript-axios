...
```typescript
import { EzsigntemplateelementdependencyRequestCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplateelementdependencyRequestCompound = {
