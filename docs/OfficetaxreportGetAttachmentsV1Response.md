...
**mPayload** | [**OfficetaxreportGetAttachmentsV1ResponseMPayload**](OfficetaxreportGetAttachmentsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { OfficetaxreportGetAttachmentsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: OfficetaxreportGetAttachmentsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
