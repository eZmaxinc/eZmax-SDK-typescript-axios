...
**mPayload** | [**VersionhistoryGetObjectV2ResponseMPayload**](VersionhistoryGetObjectV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { VersionhistoryGetObjectV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: VersionhistoryGetObjectV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
