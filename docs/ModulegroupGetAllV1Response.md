...
**mPayload** | [**ModulegroupGetAllV1ResponseMPayload**](ModulegroupGetAllV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { ModulegroupGetAllV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: ModulegroupGetAllV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
