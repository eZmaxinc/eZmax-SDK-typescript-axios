...
**mPayload** | [**FolderGetAttachmentsV1ResponseMPayload**](FolderGetAttachmentsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { FolderGetAttachmentsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: FolderGetAttachmentsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
