...
**mPayload** | [**EzsignbulksendtransmissionGetObjectV2ResponseMPayload**](EzsignbulksendtransmissionGetObjectV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsignbulksendtransmissionGetObjectV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignbulksendtransmissionGetObjectV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
