...
**mPayload** | [**SessionhistoryGetListV1ResponseMPayload**](SessionhistoryGetListV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { SessionhistoryGetListV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: SessionhistoryGetListV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
