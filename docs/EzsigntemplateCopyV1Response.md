...
**mPayload** | [**EzsigntemplateCopyV1ResponseMPayload**](EzsigntemplateCopyV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsigntemplateCopyV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplateCopyV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
