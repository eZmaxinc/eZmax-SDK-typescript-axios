...
|------------- | ------------- | -------------|
|[**leadsourceGetAutocompleteV2**](#leadsourcegetautocompletev2) | **GET** /2/object/leadsource/getAutocomplete/{sSelector} | Retrieve Leadsources and IDs|

# **leadsourceGetAutocompleteV2**
> LeadsourceGetAutocompleteV2Response leadsourceGetAutocompleteV2()
...
const apiInstance = new ObjectLeadsourceApi(configuration);

let sSelector: 'All'; //The type of Leadsources to return (default to undefined)
...
const { status, data } = await apiInstance.leadsourceGetAutocompleteV2(
    sSelector,
    eFilterActive,
    sQuery,
    acceptLanguage
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;All&#39;**]**Array<&#39;All&#39;>** | The type of Leadsources to return | defaults to undefined|
