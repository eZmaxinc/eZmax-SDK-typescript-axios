...
**mPayload** | [**ClonehistoryGetListV1ResponseMPayload**](ClonehistoryGetListV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { ClonehistoryGetListV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: ClonehistoryGetListV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
