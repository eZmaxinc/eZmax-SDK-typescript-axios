...
**mPayload** | [**AgentGetAttachmentsV1ResponseMPayload**](AgentGetAttachmentsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { AgentGetAttachmentsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: AgentGetAttachmentsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
