...
```typescript
import { TranqcontractGetCommunicationCountV1ResponseMPayload } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: TranqcontractGetCommunicationCountV1ResponseMPayload = {
    iCommunicationCount,
};
```
