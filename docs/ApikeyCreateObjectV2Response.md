...
**mPayload** | [**ApikeyCreateObjectV2ResponseMPayload**](ApikeyCreateObjectV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { ApikeyCreateObjectV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: ApikeyCreateObjectV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
