...
**mPayload** | [**PaymentpreparationImportIntoEDMV1ResponseMPayload**](PaymentpreparationImportIntoEDMV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { PaymentpreparationImportIntoEDMV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: PaymentpreparationImportIntoEDMV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
