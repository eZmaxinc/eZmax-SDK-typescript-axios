...
**mPayload** | [**SupplyGetAutocompleteV2ResponseMPayload**](SupplyGetAutocompleteV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { SupplyGetAutocompleteV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: SupplyGetAutocompleteV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
