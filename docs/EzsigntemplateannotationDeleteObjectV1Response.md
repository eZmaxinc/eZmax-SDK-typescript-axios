...
```typescript
import { EzsigntemplateannotationDeleteObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplateannotationDeleteObjectV1Response = {
    objDebugPayload,
    objDebug,
};
```
