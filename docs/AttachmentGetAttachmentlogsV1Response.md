...
**mPayload** | [**AttachmentGetAttachmentlogsV1ResponseMPayload**](AttachmentGetAttachmentlogsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { AttachmentGetAttachmentlogsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: AttachmentGetAttachmentlogsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
