...
**mPayload** | [**InscriptionnotauthenticatedGetCommunicationListV1ResponseMPayload**](InscriptionnotauthenticatedGetCommunicationListV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { InscriptionnotauthenticatedGetCommunicationListV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: InscriptionnotauthenticatedGetCommunicationListV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
