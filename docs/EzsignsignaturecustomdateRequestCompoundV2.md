...
```typescript
import { EzsignsignaturecustomdateRequestCompoundV2 } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignsignaturecustomdateRequestCompoundV2 = {
