...
------------ | ------------- | ------------- | -------------
**pkiColleagueID** | **number** | The unique ID of the Colleague | [optional] [default to undefined]
...
```typescript
import { ColleagueRequestCompoundV2 } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: ColleagueRequestCompoundV2 = {
    pkiColleagueID,
    fkiUserID,
    fkiUserIDColleague,
