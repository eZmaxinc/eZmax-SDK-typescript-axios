...
**mPayload** | [**EzsigntemplateglobalGetAutocompleteV2ResponseMPayload**](EzsigntemplateglobalGetAutocompleteV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsigntemplateglobalGetAutocompleteV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplateglobalGetAutocompleteV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
