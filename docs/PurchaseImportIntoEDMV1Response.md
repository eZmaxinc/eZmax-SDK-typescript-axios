...
**mPayload** | [**PurchaseImportIntoEDMV1ResponseMPayload**](PurchaseImportIntoEDMV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { PurchaseImportIntoEDMV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: PurchaseImportIntoEDMV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
