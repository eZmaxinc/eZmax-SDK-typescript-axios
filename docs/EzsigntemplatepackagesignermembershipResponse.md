...
------------ | ------------- | ------------- | -------------
**pkiEzsigntemplatepackagesignermembershipID** | **number** | The unique ID of the Ezsigntemplatepackagesignermembership | [default to undefined]
...
```typescript
import { EzsigntemplatepackagesignermembershipResponse } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplatepackagesignermembershipResponse = {
