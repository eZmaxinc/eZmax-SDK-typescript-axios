...
**mPayload** | [**UsergroupGetObjectV2ResponseMPayload**](UsergroupGetObjectV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { UsergroupGetObjectV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: UsergroupGetObjectV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
