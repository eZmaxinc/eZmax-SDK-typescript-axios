...
```typescript
import { EzsigntemplatesignatureDeleteObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplatesignatureDeleteObjectV1Response = {
    objDebugPayload,
    objDebug,
};
```
