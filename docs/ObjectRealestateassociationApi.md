...
|------------- | ------------- | -------------|
|[**realestateassociationGetAutocompleteV2**](#realestateassociationgetautocompletev2) | **GET** /2/object/realestateassociation/getAutocomplete/{sSelector} | Retrieve Realestateassociations and IDs|

# **realestateassociationGetAutocompleteV2**
> RealestateassociationGetAutocompleteV2Response realestateassociationGetAutocompleteV2()
...
const apiInstance = new ObjectRealestateassociationApi(configuration);

let sSelector: 'All'; //The type of Realestateassociations to return (default to undefined)
...
const { status, data } = await apiInstance.realestateassociationGetAutocompleteV2(
    sSelector,
    eFilterActive,
    sQuery,
    acceptLanguage
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;All&#39;**]**Array<&#39;All&#39;>** | The type of Realestateassociations to return | defaults to undefined|
