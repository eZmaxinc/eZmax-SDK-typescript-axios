...
**iEzsigntemplateglobalannotationX** | **number** | The x of the Ezsigntemplateglobalannotation | [default to undefined]
...
```typescript
import { EzsigntemplateglobalannotationResponseCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplateglobalannotationResponseCompound = {
