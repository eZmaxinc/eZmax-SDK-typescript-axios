...
**mPayload** | [**EzsignimportfolderGetListV1ResponseMPayload**](EzsignimportfolderGetListV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsignimportfolderGetListV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignimportfolderGetListV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
