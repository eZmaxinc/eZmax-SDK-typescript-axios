...
**mPayload** | [**ElectronicfundstransferGetCommunicationsendersV1ResponseMPayload**](ElectronicfundstransferGetCommunicationsendersV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { ElectronicfundstransferGetCommunicationsendersV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: ElectronicfundstransferGetCommunicationsendersV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
