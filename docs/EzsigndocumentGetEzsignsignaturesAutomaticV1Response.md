...
**mPayload** | [**EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload**](EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsigndocumentGetEzsignsignaturesAutomaticV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigndocumentGetEzsignsignaturesAutomaticV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
