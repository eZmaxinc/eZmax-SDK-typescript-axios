...
**mPayload** | [**SignatureCreateObjectV1ResponseMPayload**](SignatureCreateObjectV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { SignatureCreateObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: SignatureCreateObjectV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
