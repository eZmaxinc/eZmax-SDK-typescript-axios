...
**mPayload** | [**DiscussionmessageCreateObjectV1ResponseMPayload**](DiscussionmessageCreateObjectV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { DiscussionmessageCreateObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: DiscussionmessageCreateObjectV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
