...
**mPayload** | [**ApikeyRegenerateV1ResponseMPayload**](ApikeyRegenerateV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { ApikeyRegenerateV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: ApikeyRegenerateV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
