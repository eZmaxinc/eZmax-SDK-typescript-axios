...
```typescript
import { AuthenticationexternalDeleteObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: AuthenticationexternalDeleteObjectV1Response = {
    objDebugPayload,
    objDebug,
};
```
