...
**objUserstaged** | [**UserstagedResponseCompound**](UserstagedResponseCompound.md) |  | [default to undefined]

## Example

```typescript
import { WebhookUserstagedUserstagedCreated } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: WebhookUserstagedUserstagedCreated = {
    objWebhook,
    a_objAttempt,
    objUserstaged,
};
