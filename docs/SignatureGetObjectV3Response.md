...
**mPayload** | [**SignatureGetObjectV3ResponseMPayload**](SignatureGetObjectV3ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { SignatureGetObjectV3Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: SignatureGetObjectV3Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
