...
**mPayload** | [**CorsGetObjectV2ResponseMPayload**](CorsGetObjectV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { CorsGetObjectV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: CorsGetObjectV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
