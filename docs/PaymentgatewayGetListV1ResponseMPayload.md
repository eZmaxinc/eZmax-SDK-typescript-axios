...
**a_objPaymentgateway** | [**Array&lt;PaymentgatewayListElement&gt;**](PaymentgatewayListElement.md) |  | [default to undefined]

## Example

```typescript
import { PaymentgatewayGetListV1ResponseMPayload } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: PaymentgatewayGetListV1ResponseMPayload = {
    iRowReturned,
    iRowFiltered,
    a_objPaymentgateway,
};
