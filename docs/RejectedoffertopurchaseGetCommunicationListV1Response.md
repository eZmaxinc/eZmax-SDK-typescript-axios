...
**mPayload** | [**RejectedoffertopurchaseGetCommunicationListV1ResponseMPayload**](RejectedoffertopurchaseGetCommunicationListV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { RejectedoffertopurchaseGetCommunicationListV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: RejectedoffertopurchaseGetCommunicationListV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
