...
|------------- | ------------- | -------------|
|[**secretquestionGetAutocompleteV2**](#secretquestiongetautocompletev2) | **GET** /2/object/secretquestion/getAutocomplete/{sSelector} | Retrieve Secretquestions and IDs|

# **secretquestionGetAutocompleteV2**
> SecretquestionGetAutocompleteV2Response secretquestionGetAutocompleteV2()
...
const apiInstance = new ObjectSecretquestionApi(configuration);

let sSelector: 'All'; //The type of Secretquestions to return (default to undefined)
...
const { status, data } = await apiInstance.secretquestionGetAutocompleteV2(
    sSelector,
    eFilterActive,
    sQuery,
    acceptLanguage
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;All&#39;**]**Array<&#39;All&#39;>** | The type of Secretquestions to return | defaults to undefined|
