...
**mPayload** | [**EzsigndocumentGetCompletedElementsV1ResponseMPayload**](EzsigndocumentGetCompletedElementsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsigndocumentGetCompletedElementsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigndocumentGetCompletedElementsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
