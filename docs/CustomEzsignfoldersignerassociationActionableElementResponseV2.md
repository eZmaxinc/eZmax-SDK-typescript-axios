...
```typescript
import { CustomEzsignfoldersignerassociationActionableElementResponseV2 } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: CustomEzsignfoldersignerassociationActionableElementResponseV2 = {
