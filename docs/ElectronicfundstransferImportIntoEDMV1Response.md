...
**mPayload** | [**ElectronicfundstransferImportIntoEDMV1ResponseMPayload**](ElectronicfundstransferImportIntoEDMV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { ElectronicfundstransferImportIntoEDMV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: ElectronicfundstransferImportIntoEDMV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
