...
------------ | ------------- | ------------- | -------------
**pkiSubnetID** | **number** | The unique ID of the Subnet | [default to undefined]
...
```typescript
import { SubnetResponseCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: SubnetResponseCompound = {
    pkiSubnetID,
    fkiUserID,
    fkiApikeyID,
