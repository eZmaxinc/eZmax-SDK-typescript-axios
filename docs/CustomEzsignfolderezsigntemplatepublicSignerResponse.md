...
```typescript
import { CustomEzsignfolderezsigntemplatepublicSignerResponse } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: CustomEzsignfolderezsigntemplatepublicSignerResponse = {
    fkiUserID,
