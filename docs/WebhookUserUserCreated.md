...
**objUser** | [**UserResponseCompound**](UserResponseCompound.md) |  | [default to undefined]

## Example

```typescript
import { WebhookUserUserCreated } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: WebhookUserUserCreated = {
    objWebhook,
    a_objAttempt,
    objUser,
};
