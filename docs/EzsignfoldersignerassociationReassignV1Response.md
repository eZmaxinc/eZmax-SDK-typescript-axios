...
```typescript
import { EzsignfoldersignerassociationReassignV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignfoldersignerassociationReassignV1Response = {
    objDebugPayload,
    objDebug,
};
```
