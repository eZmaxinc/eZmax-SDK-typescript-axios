...
**mPayload** | [**BuyercontractImportIntoEDMV1ResponseMPayload**](BuyercontractImportIntoEDMV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { BuyercontractImportIntoEDMV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: BuyercontractImportIntoEDMV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
