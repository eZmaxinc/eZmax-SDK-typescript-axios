...
------------ | ------------- | ------------- | -------------
**pkiEzsignsignaturecustomdateID** | **number** | The unique ID of the Ezsignsignaturecustomdate | [optional] [default to undefined]
**iEzsignsignaturecustomdateX** | **number** | The X coordinate (Horizontal) where to put the Ezsignsignaturecustomdate on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsignsignaturecustomdate block 2 inches from the left border of the page, you would use \&quot;200\&quot; for the X coordinate. | [optional] [default to undefined]
**iEzsignsignaturecustomdateY** | **number** | The Y coordinate (Vertical) where to put the Ezsignsignaturecustomdate on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsignsignaturecustomdate block 3 inches from the top border of the page, you would use \&quot;300\&quot; for the Y coordinate. | [optional] [default to undefined]
...
**iEzsignsignaturecustomdateOffsety** | **number** | The Y coordinate (Vertical) where to put the Ezsignsignaturecustomdate on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsignsignaturecustomdate block 3 inches from the top of the signature, you would use \&quot;300\&quot; for the Y coordinate. | [optional] [default to undefined]
...
```typescript
import { EzsignsignaturecustomdateRequestCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignsignaturecustomdateRequestCompound = {
