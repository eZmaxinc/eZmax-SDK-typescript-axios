...
**mPayload** | [**EzmaxinvoicingGetProvisionalV1ResponseMPayload**](EzmaxinvoicingGetProvisionalV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzmaxinvoicingGetProvisionalV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzmaxinvoicingGetProvisionalV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
