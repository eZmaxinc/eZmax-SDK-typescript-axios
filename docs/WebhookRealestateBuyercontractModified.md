...
**objBuyercontract** | [**BuyercontractResponse**](BuyercontractResponse.md) |  | [default to undefined]

## Example

```typescript
import { WebhookRealestateBuyercontractModified } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: WebhookRealestateBuyercontractModified = {
    objWebhook,
    a_objAttempt,
    objBuyercontract,
};
