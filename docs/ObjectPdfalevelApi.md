...
|------------- | ------------- | -------------|
|[**pdfalevelGetAutocompleteV2**](#pdfalevelgetautocompletev2) | **GET** /2/object/pdfalevel/getAutocomplete/{sSelector} | Retrieve Pdfalevels and IDs|

# **pdfalevelGetAutocompleteV2**
> PdfalevelGetAutocompleteV2Response pdfalevelGetAutocompleteV2()
...
const apiInstance = new ObjectPdfalevelApi(configuration);

let sSelector: 'All'; //The type of Pdfalevels to return (default to undefined)
...
const { status, data } = await apiInstance.pdfalevelGetAutocompleteV2(
    sSelector,
    eFilterActive,
    sQuery,
    acceptLanguage
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | [**&#39;All&#39;**]**Array<&#39;All&#39;>** | The type of Pdfalevels to return | defaults to undefined|
