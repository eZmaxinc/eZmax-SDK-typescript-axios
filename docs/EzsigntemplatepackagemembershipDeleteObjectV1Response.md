...
```typescript
import { EzsigntemplatepackagemembershipDeleteObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplatepackagemembershipDeleteObjectV1Response = {
    objDebugPayload,
    objDebug,
};
```
