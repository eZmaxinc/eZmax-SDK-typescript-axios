...
```typescript
import { InscriptionnotauthenticatedFillInscriptionnotauthenticatedconditionV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: InscriptionnotauthenticatedFillInscriptionnotauthenticatedconditionV1Response = {
    objDebugPayload,
    objDebug,
};
```
