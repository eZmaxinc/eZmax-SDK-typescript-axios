...
```typescript
import { EzsigntemplatesignaturecustomdateResponseCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplatesignaturecustomdateResponseCompound = {
