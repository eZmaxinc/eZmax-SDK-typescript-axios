...
**mPayload** | [**RejectedoffertopurchaseGetListV1ResponseMPayload**](RejectedoffertopurchaseGetListV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { RejectedoffertopurchaseGetListV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: RejectedoffertopurchaseGetListV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
