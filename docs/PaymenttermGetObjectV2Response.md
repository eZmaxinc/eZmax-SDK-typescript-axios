...
**mPayload** | [**PaymenttermGetObjectV2ResponseMPayload**](PaymenttermGetObjectV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { PaymenttermGetObjectV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: PaymenttermGetObjectV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
