...
**mPayload** | [**InscriptiontempGetCommunicationsendersV1ResponseMPayload**](InscriptiontempGetCommunicationsendersV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { InscriptiontempGetCommunicationsendersV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: InscriptiontempGetCommunicationsendersV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
