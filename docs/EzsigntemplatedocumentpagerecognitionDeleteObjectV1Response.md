...
```typescript
import { EzsigntemplatedocumentpagerecognitionDeleteObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplatedocumentpagerecognitionDeleteObjectV1Response = {
    objDebugPayload,
    objDebug,
};
```
