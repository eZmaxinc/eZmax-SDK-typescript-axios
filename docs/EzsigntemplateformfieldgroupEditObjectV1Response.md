...
```typescript
import { EzsigntemplateformfieldgroupEditObjectV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplateformfieldgroupEditObjectV1Response = {
    objDebugPayload,
    objDebug,
};
```
