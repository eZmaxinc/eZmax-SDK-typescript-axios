...
------------ | ------------- | ------------- | -------------
**pkiPermissionID** | **number** | The unique ID of the Permission | [default to undefined]
...
```typescript
import { PermissionResponseCompound } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: PermissionResponseCompound = {
    pkiPermissionID,
    fkiUserID,
    fkiApikeyID,
    fkiUsergroupID,
