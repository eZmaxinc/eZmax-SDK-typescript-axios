...
**mPayload** | [**EzsigntemplateglobalannotationGetObjectV2ResponseMPayload**](EzsigntemplateglobalannotationGetObjectV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsigntemplateglobalannotationGetObjectV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigntemplateglobalannotationGetObjectV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
