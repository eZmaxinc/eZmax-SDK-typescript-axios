...
**mPayload** | [**UsergroupGetUsergroupmembershipsV1ResponseMPayload**](UsergroupGetUsergroupmembershipsV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { UsergroupGetUsergroupmembershipsV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: UsergroupGetUsergroupmembershipsV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
