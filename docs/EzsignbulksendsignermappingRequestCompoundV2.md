...
```typescript
import { EzsignbulksendsignermappingRequestCompoundV2 } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignbulksendsignermappingRequestCompoundV2 = {
