...
**mPayload** | [**EzsignfolderGetAttachmentCountV1ResponseMPayload**](EzsignfolderGetAttachmentCountV1ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsignfolderGetAttachmentCountV1Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsignfolderGetAttachmentCountV1Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
