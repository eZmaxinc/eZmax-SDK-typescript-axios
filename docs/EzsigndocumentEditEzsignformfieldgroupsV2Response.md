...
**mPayload** | [**EzsigndocumentEditEzsignformfieldgroupsV2ResponseMPayload**](EzsigndocumentEditEzsignformfieldgroupsV2ResponseMPayload.md) |  | [default to undefined]

## Example

```typescript
import { EzsigndocumentEditEzsignformfieldgroupsV2Response } from '@ezmaxinc/ezmax-sdk-typescript-axios';

const instance: EzsigndocumentEditEzsignformfieldgroupsV2Response = {
    objDebugPayload,
    objDebug,
    mPayload,
};
