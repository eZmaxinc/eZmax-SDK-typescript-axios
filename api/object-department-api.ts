...
export const ObjectDepartmentApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        departmentGetAutocompleteV2: async (sSelector: DepartmentGetAutocompleteV2SSelectorEnum, eFilterActive?: DepartmentGetAutocompleteV2EFilterActiveEnum, sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ObjectDepartmentApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        departmentGetAutocompleteV2(sSelector: DepartmentGetAutocompleteV2SSelectorEnum, eFilterActive?: DepartmentGetAutocompleteV2EFilterActiveEnum, sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: any): AxiosPromise<DepartmentGetAutocompleteV2Response> {
...
export class ObjectDepartmentApi extends BaseAPI {
     ...
     */
    public departmentGetAutocompleteV2(sSelector: DepartmentGetAutocompleteV2SSelectorEnum, eFilterActive?: DepartmentGetAutocompleteV2EFilterActiveEnum, sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: AxiosRequestConfig) {
