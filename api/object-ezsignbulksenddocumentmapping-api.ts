...
// @ts-ignore
import type { EzsignbulksenddocumentmappingGetObjectV3Response } from '../model';
// @ts-ignore
...
export const ObjectEzsignbulksenddocumentmappingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        ezsignbulksenddocumentmappingGetObjectV3: async (pkiEzsignbulksenddocumentmappingID: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsignbulksenddocumentmappingID' is not null or undefined
            assertParamExists('ezsignbulksenddocumentmappingGetObjectV3', 'pkiEzsignbulksenddocumentmappingID', pkiEzsignbulksenddocumentmappingID)
            const localVarPath = `/3/object/ezsignbulksenddocumentmapping/{pkiEzsignbulksenddocumentmappingID}`
                .replace('{pkiEzsignbulksenddocumentmappingID}', encodeURIComponent(String(pkiEzsignbulksenddocumentmappingID)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            let basePath = DUMMY_BASE_URL
            if (configuration && configuration.basePath) basePath = configuration.basePath
...
export const ObjectEzsignbulksenddocumentmappingApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async ezsignbulksenddocumentmappingGetObjectV3(pkiEzsignbulksenddocumentmappingID: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsignbulksenddocumentmappingGetObjectV3Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsignbulksenddocumentmappingGetObjectV3(pkiEzsignbulksenddocumentmappingID, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsignbulksenddocumentmappingApi.ezsignbulksenddocumentmappingGetObjectV3']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const ObjectEzsignbulksenddocumentmappingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        ezsignbulksenddocumentmappingGetObjectV3(pkiEzsignbulksenddocumentmappingID: number, options?: RawAxiosRequestConfig): AxiosPromise<EzsignbulksenddocumentmappingGetObjectV3Response> {
            return localVarFp.ezsignbulksenddocumentmappingGetObjectV3(pkiEzsignbulksenddocumentmappingID, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ObjectEzsignbulksenddocumentmappingApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public ezsignbulksenddocumentmappingGetObjectV3(pkiEzsignbulksenddocumentmappingID: number, options?: RawAxiosRequestConfig) {
        return ObjectEzsignbulksenddocumentmappingApiFp(this.configuration).ezsignbulksenddocumentmappingGetObjectV3(pkiEzsignbulksenddocumentmappingID, options).then((request) => request(this.axios, this.basePath));
    }
}
