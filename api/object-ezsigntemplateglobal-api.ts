...
// @ts-ignore
import type { EzsigntemplateglobalGetAutocompleteV2Response } from '../model';
// @ts-ignore
import type { EzsigntemplateglobalGetObjectV2Response } from '../model';
// @ts-ignore
...
export const ObjectEzsigntemplateglobalApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplateglobalGetAutocompleteV2(sSelector: EzsigntemplateglobalGetAutocompleteV2SSelectorEnum, eFilterActive?: EzsigntemplateglobalGetAutocompleteV2EFilterActiveEnum, sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: RawAxiosRequestConfig): AxiosPromise<EzsigntemplateglobalGetAutocompleteV2Response> {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplateglobalGetObjectV2(pkiEzsigntemplateglobalID: number, options?: RawAxiosRequestConfig): AxiosPromise<EzsigntemplateglobalGetObjectV2Response> {
