...
export const ObjectEzsigntemplatesignatureApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        ezsigntemplatesignatureCreateObjectV1: async (ezsigntemplatesignatureCreateObjectV1Request: EzsigntemplatesignatureCreateObjectV1Request, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatesignatureEditObjectV1: async (pkiEzsigntemplatesignatureID: number, ezsigntemplatesignatureEditObjectV1Request: EzsigntemplatesignatureEditObjectV1Request, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsigntemplatesignatureID' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatesignatureGetObjectV2: async (pkiEzsigntemplatesignatureID: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsigntemplatesignatureID' is not null or undefined
...
export const ObjectEzsigntemplatesignatureApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async ezsigntemplatesignatureCreateObjectV1(ezsigntemplatesignatureCreateObjectV1Request: EzsigntemplatesignatureCreateObjectV1Request, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsigntemplatesignatureCreateObjectV1Response>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsigntemplatesignatureApi.ezsigntemplatesignatureCreateObjectV1']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async ezsigntemplatesignatureEditObjectV1(pkiEzsigntemplatesignatureID: number, ezsigntemplatesignatureEditObjectV1Request: EzsigntemplatesignatureEditObjectV1Request, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsigntemplatesignatureEditObjectV1Response>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsigntemplatesignatureApi.ezsigntemplatesignatureEditObjectV1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async ezsigntemplatesignatureGetObjectV2(pkiEzsigntemplatesignatureID: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsigntemplatesignatureGetObjectV2Response>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsigntemplatesignatureApi.ezsigntemplatesignatureGetObjectV2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export class ObjectEzsigntemplatesignatureApi extends BaseAPI {
     ...
     */
    public ezsigntemplatesignatureCreateObjectV1(ezsigntemplatesignatureCreateObjectV1Request: EzsigntemplatesignatureCreateObjectV1Request, options?: RawAxiosRequestConfig) {
     ...
     * @memberof ObjectEzsigntemplatesignatureApi
     */
    public ezsigntemplatesignatureEditObjectV1(pkiEzsigntemplatesignatureID: number, ezsigntemplatesignatureEditObjectV1Request: EzsigntemplatesignatureEditObjectV1Request, options?: RawAxiosRequestConfig) {
     ...
     * @memberof ObjectEzsigntemplatesignatureApi
     */
    public ezsigntemplatesignatureGetObjectV2(pkiEzsigntemplatesignatureID: number, options?: RawAxiosRequestConfig) {
