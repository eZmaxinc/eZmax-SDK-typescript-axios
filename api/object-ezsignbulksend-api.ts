...
// @ts-ignore
import type { EzsignbulksendCreateEzsignbulksendtransmissionV2Response } from '../model';
// @ts-ignore
import type { EzsignbulksendCreateObjectV1Request } from '../model';
// @ts-ignore
import type { EzsignbulksendCreateObjectV1Response } from '../model';
// @ts-ignore
import type { EzsignbulksendCreateObjectV2Request } from '../model';
// @ts-ignore
import type { EzsignbulksendCreateObjectV2Response } from '../model';
// @ts-ignore
...
// @ts-ignore
import type { EzsignbulksendGetEzsignsignaturesAutomaticV1Response } from '../model';
// @ts-ignore
import type { EzsignbulksendGetFormsDataV1Response } from '../model';
// @ts-ignore
import type { EzsignbulksendGetListV1Response } from '../model';
// @ts-ignore
import type { EzsignbulksendGetObjectV2Response } from '../model';
// @ts-ignore
import type { EzsignbulksendGetObjectV3Response } from '../model';
// @ts-ignore
import type { EzsignbulksendGetObjectV4Response } from '../model';
// @ts-ignore
...
export const ObjectEzsignbulksendApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * The endpoint allows to create one or many elements at once.
         * @summary Create a new Ezsignbulksend
         * @param {EzsignbulksendCreateObjectV2Request} ezsignbulksendCreateObjectV2Request 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        ezsignbulksendCreateObjectV2: async (ezsignbulksendCreateObjectV2Request: EzsignbulksendCreateObjectV2Request, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'ezsignbulksendCreateObjectV2Request' is not null or undefined
            assertParamExists('ezsignbulksendCreateObjectV2', 'ezsignbulksendCreateObjectV2Request', ezsignbulksendCreateObjectV2Request)
            const localVarPath = `/2/object/ezsignbulksend`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            let basePath = DUMMY_BASE_URL
            if (configuration && configuration.basePath) basePath = configuration.basePath
            //const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            //localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.headers = {...headersFromBaseOptions, ...localVarHeaderParameter,  ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(ezsignbulksendCreateObjectV2Request, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        ezsignbulksendEditObjectV2: async (pkiEzsignbulksendID: number, ezsignbulksendEditObjectV2Request: EzsignbulksendEditObjectV2Request, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsignbulksendID' is not null or undefined
            assertParamExists('ezsignbulksendEditObjectV2', 'pkiEzsignbulksendID', pkiEzsignbulksendID)
            ...
            //localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.headers = {...headersFromBaseOptions, ...localVarHeaderParameter,  ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(ezsignbulksendEditObjectV2Request, localVarRequestOptions, configuration)
         ...
         * @param {number} pkiEzsignbulksendID 
         * @param {boolean} [bIncludeSigned] Include final document once all signatures were applied
         * @param {boolean} [bIncludeAttachment] Include attached files in signatures
         * @param {boolean} [bIncludeProofdocument] Include the evidence report
         * @param {boolean} [bIncludeProof] include the complete evidence archive including all of the above and more
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        ezsignbulksendGetBatchFileV1: async (pkiEzsignbulksendID: number, bIncludeSigned?: boolean, bIncludeAttachment?: boolean, bIncludeProofdocument?: boolean, bIncludeProof?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsignbulksendID' is not null or undefined
            ...
            if (bIncludeSigned !== undefined) {
                localVarQueryParameter['bIncludeSigned'] = bIncludeSigned;
            }

            if (bIncludeAttachment !== undefined) {
                localVarQueryParameter['bIncludeAttachment'] = bIncludeAttachment;
            }

            if (bIncludeProofdocument !== undefined) {
                localVarQueryParameter['bIncludeProofdocument'] = bIncludeProofdocument;
            }

            if (bIncludeProof !== undefined) {
         ...
         * @throws {RequiredError}
         */
        ezsignbulksendGetObjectV3: async (pkiEzsignbulksendID: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsignbulksendID' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        ezsignbulksendGetObjectV4: async (pkiEzsignbulksendID: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsignbulksendID' is not null or undefined
            assertParamExists('ezsignbulksendGetObjectV4', 'pkiEzsignbulksendID', pkiEzsignbulksendID)
            const localVarPath = `/4/object/ezsignbulksend/{pkiEzsignbulksendID}`
                .replace('{pkiEzsignbulksendID}', encodeURIComponent(String(pkiEzsignbulksendID)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            let basePath = DUMMY_BASE_URL
            if (configuration && configuration.basePath) basePath = configuration.basePath
...
export const ObjectEzsignbulksendApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async ezsignbulksendCreateObjectV2(ezsignbulksendCreateObjectV2Request: EzsignbulksendCreateObjectV2Request, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsignbulksendCreateObjectV2Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsignbulksendCreateObjectV2(ezsignbulksendCreateObjectV2Request, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsignbulksendApi.ezsignbulksendCreateObjectV2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async ezsignbulksendEditObjectV2(pkiEzsignbulksendID: number, ezsignbulksendEditObjectV2Request: EzsignbulksendEditObjectV2Request, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsignbulksendEditObjectV2Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsignbulksendEditObjectV2(pkiEzsignbulksendID, ezsignbulksendEditObjectV2Request, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsignbulksendApi.ezsignbulksendEditObjectV2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async ezsignbulksendGetBatchFileV1(pkiEzsignbulksendID: number, bIncludeSigned?: boolean, bIncludeAttachment?: boolean, bIncludeProofdocument?: boolean, bIncludeProof?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsignbulksendGetBatchFileV1(pkiEzsignbulksendID, bIncludeSigned, bIncludeAttachment, bIncludeProofdocument, bIncludeProof, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsignbulksendApi.ezsignbulksendGetBatchFileV1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async ezsignbulksendGetObjectV3(pkiEzsignbulksendID: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsignbulksendGetObjectV3Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsignbulksendGetObjectV3(pkiEzsignbulksendID, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsignbulksendApi.ezsignbulksendGetObjectV3']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async ezsignbulksendGetObjectV4(pkiEzsignbulksendID: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsignbulksendGetObjectV4Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsignbulksendGetObjectV4(pkiEzsignbulksendID, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsignbulksendApi.ezsignbulksendGetObjectV4']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const ObjectEzsignbulksendApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        ezsignbulksendCreateEzsignbulksendtransmissionV2(pkiEzsignbulksendID: number, ezsignbulksendCreateEzsignbulksendtransmissionV2Request: EzsignbulksendCreateEzsignbulksendtransmissionV2Request, options?: RawAxiosRequestConfig): AxiosPromise<EzsignbulksendCreateEzsignbulksendtransmissionV2Response> {
         ...
         * @throws {RequiredError}
         */
        ezsignbulksendCreateObjectV1(ezsignbulksendCreateObjectV1Request: EzsignbulksendCreateObjectV1Request, options?: RawAxiosRequestConfig): AxiosPromise<EzsignbulksendCreateObjectV1Response> {
         ...
         * @throws {RequiredError}
         */
        ezsignbulksendCreateObjectV2(ezsignbulksendCreateObjectV2Request: EzsignbulksendCreateObjectV2Request, options?: RawAxiosRequestConfig): AxiosPromise<EzsignbulksendCreateObjectV2Response> {
            return localVarFp.ezsignbulksendCreateObjectV2(ezsignbulksendCreateObjectV2Request, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Delete an existing Ezsignbulksend
         ...
         * @throws {RequiredError}
         */
        ezsignbulksendEditObjectV2(pkiEzsignbulksendID: number, ezsignbulksendEditObjectV2Request: EzsignbulksendEditObjectV2Request, options?: RawAxiosRequestConfig): AxiosPromise<EzsignbulksendEditObjectV2Response> {
            return localVarFp.ezsignbulksendEditObjectV2(pkiEzsignbulksendID, ezsignbulksendEditObjectV2Request, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Retrieve file to download documents in batch
         ...
         * @throws {RequiredError}
         */
        ezsignbulksendGetBatchFileV1(pkiEzsignbulksendID: number, bIncludeSigned?: boolean, bIncludeAttachment?: boolean, bIncludeProofdocument?: boolean, bIncludeProof?: boolean, options?: RawAxiosRequestConfig): AxiosPromise<File> {
            return localVarFp.ezsignbulksendGetBatchFileV1(pkiEzsignbulksendID, bIncludeSigned, bIncludeAttachment, bIncludeProofdocument, bIncludeProof, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Retrieve an existing Ezsignbulksend\'s empty Csv template
         ...
         * @throws {RequiredError}
         */
        ezsignbulksendGetCsvTemplateV1(pkiEzsignbulksendID: number, eCsvSeparator: EzsignbulksendGetCsvTemplateV1ECsvSeparatorEnum, options?: RawAxiosRequestConfig): AxiosPromise<string> {
         ...
         * @throws {RequiredError}
         */
        ezsignbulksendGetEzsignbulksendtransmissionsV1(pkiEzsignbulksendID: number, options?: RawAxiosRequestConfig): AxiosPromise<EzsignbulksendGetEzsignbulksendtransmissionsV1Response> {
         ...
         * @throws {RequiredError}
         */
        ezsignbulksendGetEzsignsignaturesAutomaticV1(pkiEzsignbulksendID: number, options?: RawAxiosRequestConfig): AxiosPromise<EzsignbulksendGetEzsignsignaturesAutomaticV1Response> {
         ...
         * @throws {RequiredError}
         */
        ezsignbulksendGetFormsDataV1(pkiEzsignbulksendID: number, options?: RawAxiosRequestConfig): AxiosPromise<EzsignbulksendGetFormsDataV1Response> {
         ...
         * @throws {RequiredError}
         */
        ezsignbulksendGetListV1(eOrderBy?: EzsignbulksendGetListV1EOrderByEnum, iRowMax?: number, iRowOffset?: number, acceptLanguage?: HeaderAcceptLanguage, sFilter?: string, options?: RawAxiosRequestConfig): AxiosPromise<EzsignbulksendGetListV1Response> {
         ...
         * @throws {RequiredError}
         */
        ezsignbulksendGetObjectV2(pkiEzsignbulksendID: number, options?: RawAxiosRequestConfig): AxiosPromise<EzsignbulksendGetObjectV2Response> {
         ...
         * @throws {RequiredError}
         */
        ezsignbulksendGetObjectV3(pkiEzsignbulksendID: number, options?: RawAxiosRequestConfig): AxiosPromise<EzsignbulksendGetObjectV3Response> {
            return localVarFp.ezsignbulksendGetObjectV3(pkiEzsignbulksendID, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Retrieve an existing Ezsignbulksend
         ...
         * @throws {RequiredError}
         */
        ezsignbulksendGetObjectV4(pkiEzsignbulksendID: number, options?: RawAxiosRequestConfig): AxiosPromise<EzsignbulksendGetObjectV4Response> {
            return localVarFp.ezsignbulksendGetObjectV4(pkiEzsignbulksendID, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Reorder Ezsignbulksenddocumentmappings in the Ezsignbulksend
...
export class ObjectEzsignbulksendApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public ezsignbulksendCreateObjectV2(ezsignbulksendCreateObjectV2Request: EzsignbulksendCreateObjectV2Request, options?: RawAxiosRequestConfig) {
        return ObjectEzsignbulksendApiFp(this.configuration).ezsignbulksendCreateObjectV2(ezsignbulksendCreateObjectV2Request, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public ezsignbulksendEditObjectV2(pkiEzsignbulksendID: number, ezsignbulksendEditObjectV2Request: EzsignbulksendEditObjectV2Request, options?: RawAxiosRequestConfig) {
        return ObjectEzsignbulksendApiFp(this.configuration).ezsignbulksendEditObjectV2(pkiEzsignbulksendID, ezsignbulksendEditObjectV2Request, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public ezsignbulksendGetBatchFileV1(pkiEzsignbulksendID: number, bIncludeSigned?: boolean, bIncludeAttachment?: boolean, bIncludeProofdocument?: boolean, bIncludeProof?: boolean, options?: RawAxiosRequestConfig) {
        return ObjectEzsignbulksendApiFp(this.configuration).ezsignbulksendGetBatchFileV1(pkiEzsignbulksendID, bIncludeSigned, bIncludeAttachment, bIncludeProofdocument, bIncludeProof, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public ezsignbulksendGetObjectV3(pkiEzsignbulksendID: number, options?: RawAxiosRequestConfig) {
        return ObjectEzsignbulksendApiFp(this.configuration).ezsignbulksendGetObjectV3(pkiEzsignbulksendID, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public ezsignbulksendGetObjectV4(pkiEzsignbulksendID: number, options?: RawAxiosRequestConfig) {
        return ObjectEzsignbulksendApiFp(this.configuration).ezsignbulksendGetObjectV4(pkiEzsignbulksendID, options).then((request) => request(this.axios, this.basePath));
    }
