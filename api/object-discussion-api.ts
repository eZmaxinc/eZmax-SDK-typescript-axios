...
// @ts-ignore
import type { DiscussionChatV1200Response } from '../model';
// @ts-ignore
import type { DiscussionChatV1Request } from '../model';
// @ts-ignore
...
export const ObjectDiscussionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {DiscussionChatV1Request} discussionChatV1Request 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        discussionChatV1: async (discussionChatV1Request: DiscussionChatV1Request, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'discussionChatV1Request' is not null or undefined
            assertParamExists('discussionChatV1', 'discussionChatV1Request', discussionChatV1Request)
            const localVarPath = `/1/object/discussion/chat`;
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(discussionChatV1Request, localVarRequestOptions, configuration)
...
export const ObjectDiscussionApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async discussionChatV1(discussionChatV1Request: DiscussionChatV1Request, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DiscussionChatV1200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.discussionChatV1(discussionChatV1Request, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectDiscussionApi.discussionChatV1']?.[localVarOperationServerIndex]?.url;
...
export const ObjectDiscussionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        discussionChatV1(discussionChatV1Request: DiscussionChatV1Request, options?: RawAxiosRequestConfig): AxiosPromise<DiscussionChatV1200Response> {
            return localVarFp.discussionChatV1(discussionChatV1Request, options).then((request) => request(axios, basePath));
        },
        /**
         * The endpoint allows to create one or many elements at once.
         * @summary Create a new Discussion
...
export class ObjectDiscussionApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public discussionChatV1(discussionChatV1Request: DiscussionChatV1Request, options?: RawAxiosRequestConfig) {
        return ObjectDiscussionApiFp(this.configuration).discussionChatV1(discussionChatV1Request, options).then((request) => request(this.axios, this.basePath));
    }
