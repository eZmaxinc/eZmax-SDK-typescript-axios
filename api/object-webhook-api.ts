...
export const ObjectWebhookApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        webhookTestUrlV1: async (pkiWebhookID: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiWebhookID' is not null or undefined
            assertParamExists('webhookTestUrlV1', 'pkiWebhookID', pkiWebhookID)
...
export const ObjectWebhookApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async webhookTestUrlV1(pkiWebhookID: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WebhookTestV1Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.webhookTestUrlV1(pkiWebhookID, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const ObjectWebhookApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        webhookTestUrlV1(pkiWebhookID: number, options?: any): AxiosPromise<WebhookTestV1Response> {
            return localVarFp.webhookTestUrlV1(pkiWebhookID, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ObjectWebhookApi extends BaseAPI {
     ...
     * @memberof ObjectWebhookApi
     */
    public webhookTestUrlV1(pkiWebhookID: number, options?: AxiosRequestConfig) {
        return ObjectWebhookApiFp(this.configuration).webhookTestUrlV1(pkiWebhookID, options).then((request) => request(this.axios, this.basePath));
    }
}
