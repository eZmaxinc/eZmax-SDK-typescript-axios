...
export const ObjectNotificationtestApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        notificationtestGetElementsV2: async (pkiNotificationtestID: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiNotificationtestID' is not null or undefined
            assertParamExists('notificationtestGetElementsV2', 'pkiNotificationtestID', pkiNotificationtestID)
            const localVarPath = `/2/object/notificationtest/{pkiNotificationtestID}/getElements`
...
export const ObjectNotificationtestApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async notificationtestGetElementsV2(pkiNotificationtestID: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<NotificationtestGetElementsV2Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.notificationtestGetElementsV2(pkiNotificationtestID, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectNotificationtestApi.notificationtestGetElementsV2']?.[localVarOperationServerIndex]?.url;
...
export const ObjectNotificationtestApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        notificationtestGetElementsV2(pkiNotificationtestID: number, options?: RawAxiosRequestConfig): AxiosPromise<NotificationtestGetElementsV2Response> {
            return localVarFp.notificationtestGetElementsV2(pkiNotificationtestID, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ObjectNotificationtestApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public notificationtestGetElementsV2(pkiNotificationtestID: number, options?: RawAxiosRequestConfig) {
        return ObjectNotificationtestApiFp(this.configuration).notificationtestGetElementsV2(pkiNotificationtestID, options).then((request) => request(this.axios, this.basePath));
    }
}
