...
// @ts-ignore
import type { InscriptionnotauthenticatedGetObjectV2Response } from '../model';
// @ts-ignore
...
export const ObjectInscriptionnotauthenticatedApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {number} pkiInscriptionnotauthenticatedID The unique ID of the Inscriptionnotauthenticated
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        inscriptionnotauthenticatedGetObjectV2: async (pkiInscriptionnotauthenticatedID: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiInscriptionnotauthenticatedID' is not null or undefined
            assertParamExists('inscriptionnotauthenticatedGetObjectV2', 'pkiInscriptionnotauthenticatedID', pkiInscriptionnotauthenticatedID)
            const localVarPath = `/2/object/inscriptionnotauthenticated/{pkiInscriptionnotauthenticatedID}`
                .replace('{pkiInscriptionnotauthenticatedID}', encodeURIComponent(String(pkiInscriptionnotauthenticatedID)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            let basePath = DUMMY_BASE_URL
            if (configuration && configuration.basePath) basePath = configuration.basePath
...
export const ObjectInscriptionnotauthenticatedApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async inscriptionnotauthenticatedGetObjectV2(pkiInscriptionnotauthenticatedID: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InscriptionnotauthenticatedGetObjectV2Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.inscriptionnotauthenticatedGetObjectV2(pkiInscriptionnotauthenticatedID, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectInscriptionnotauthenticatedApi.inscriptionnotauthenticatedGetObjectV2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const ObjectInscriptionnotauthenticatedApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        inscriptionnotauthenticatedGetObjectV2(pkiInscriptionnotauthenticatedID: number, options?: RawAxiosRequestConfig): AxiosPromise<InscriptionnotauthenticatedGetObjectV2Response> {
            return localVarFp.inscriptionnotauthenticatedGetObjectV2(pkiInscriptionnotauthenticatedID, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Import attachments into the Inscriptionnotauthenticated
...
export class ObjectInscriptionnotauthenticatedApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public inscriptionnotauthenticatedGetObjectV2(pkiInscriptionnotauthenticatedID: number, options?: RawAxiosRequestConfig) {
        return ObjectInscriptionnotauthenticatedApiFp(this.configuration).inscriptionnotauthenticatedGetObjectV2(pkiInscriptionnotauthenticatedID, options).then((request) => request(this.axios, this.basePath));
    }
...
export const InscriptionnotauthenticatedGetListV1EOrderByEnum = {
    ...
    bInscriptionnotauthenticatedDraft_ASC: 'bInscriptionnotauthenticatedDraft_ASC',
    bInscriptionnotauthenticatedDraft_DESC: 'bInscriptionnotauthenticatedDraft_DESC',
