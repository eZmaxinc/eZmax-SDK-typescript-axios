...
export const ObjectModulegroupApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {'Api' | 'User'} eContext The context of the Modulegroup
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        modulegroupGetAllV1: async (eContext: 'Api' | 'User', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ObjectModulegroupApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async modulegroupGetAllV1(eContext: 'Api' | 'User', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ModulegroupGetAllV1Response>> {
...
export const ObjectModulegroupApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        modulegroupGetAllV1(eContext: 'Api' | 'User', options?: any): AxiosPromise<ModulegroupGetAllV1Response> {
...
export class ObjectModulegroupApi extends BaseAPI {
     ...
     */
    public modulegroupGetAllV1(eContext: 'Api' | 'User', options?: AxiosRequestConfig) {
