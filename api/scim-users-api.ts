...
export const ScimUsersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        usersCreateObjectScimV2: async (scimUser: ScimUser, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        usersDeleteObjectScimV2: async (userId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        usersEditObjectScimV2: async (userId: string, scimUser: ScimUser, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'userId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        usersGetListScimV2: async (filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/2/scim/Users`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            let basePath = DUMMY_BASE_URL
            if (configuration && configuration.basePath) basePath = configuration.basePath
         ...
         * @throws {RequiredError}
         */
        usersGetObjectScimV2: async (userId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'userId' is not null or undefined
...
export const ScimUsersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async usersCreateObjectScimV2(scimUser: ScimUser, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ScimUser>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.usersCreateObjectScimV2(scimUser, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ScimUsersApi.usersCreateObjectScimV2']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async usersDeleteObjectScimV2(userId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.usersDeleteObjectScimV2(userId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ScimUsersApi.usersDeleteObjectScimV2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async usersEditObjectScimV2(userId: string, scimUser: ScimUser, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ScimUser>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.usersEditObjectScimV2(userId, scimUser, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ScimUsersApi.usersEditObjectScimV2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async usersGetListScimV2(filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ScimUserList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.usersGetListScimV2(filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ScimUsersApi.usersGetListScimV2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async usersGetObjectScimV2(userId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ScimUser>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.usersGetObjectScimV2(userId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ScimUsersApi.usersGetObjectScimV2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export class ScimUsersApi extends BaseAPI {
     ...
     */
    public usersCreateObjectScimV2(scimUser: ScimUser, options?: RawAxiosRequestConfig) {
     ...
     * @memberof ScimUsersApi
     */
    public usersDeleteObjectScimV2(userId: string, options?: RawAxiosRequestConfig) {
     ...
     * @memberof ScimUsersApi
     */
    public usersEditObjectScimV2(userId: string, scimUser: ScimUser, options?: RawAxiosRequestConfig) {
     ...
     * @memberof ScimUsersApi
     */
    public usersGetListScimV2(filter?: string, options?: RawAxiosRequestConfig) {
     ...
     * @memberof ScimUsersApi
     */
    public usersGetObjectScimV2(userId: string, options?: RawAxiosRequestConfig) {
