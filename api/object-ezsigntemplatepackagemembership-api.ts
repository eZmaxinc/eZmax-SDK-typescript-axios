...
// @ts-ignore
import type { EzsigntemplatepackagemembershipGetObjectV3Response } from '../model';
// @ts-ignore
...
export const ObjectEzsigntemplatepackagemembershipApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepackagemembershipGetObjectV3: async (pkiEzsigntemplatepackagemembershipID: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsigntemplatepackagemembershipID' is not null or undefined
            assertParamExists('ezsigntemplatepackagemembershipGetObjectV3', 'pkiEzsigntemplatepackagemembershipID', pkiEzsigntemplatepackagemembershipID)
            const localVarPath = `/3/object/ezsigntemplatepackagemembership/{pkiEzsigntemplatepackagemembershipID}`
                .replace('{pkiEzsigntemplatepackagemembershipID}', encodeURIComponent(String(pkiEzsigntemplatepackagemembershipID)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            let basePath = DUMMY_BASE_URL
            if (configuration && configuration.basePath) basePath = configuration.basePath
...
export const ObjectEzsigntemplatepackagemembershipApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async ezsigntemplatepackagemembershipGetObjectV3(pkiEzsigntemplatepackagemembershipID: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsigntemplatepackagemembershipGetObjectV3Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsigntemplatepackagemembershipGetObjectV3(pkiEzsigntemplatepackagemembershipID, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsigntemplatepackagemembershipApi.ezsigntemplatepackagemembershipGetObjectV3']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const ObjectEzsigntemplatepackagemembershipApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepackagemembershipGetObjectV3(pkiEzsigntemplatepackagemembershipID: number, options?: RawAxiosRequestConfig): AxiosPromise<EzsigntemplatepackagemembershipGetObjectV3Response> {
            return localVarFp.ezsigntemplatepackagemembershipGetObjectV3(pkiEzsigntemplatepackagemembershipID, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ObjectEzsigntemplatepackagemembershipApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public ezsigntemplatepackagemembershipGetObjectV3(pkiEzsigntemplatepackagemembershipID: number, options?: RawAxiosRequestConfig) {
        return ObjectEzsigntemplatepackagemembershipApiFp(this.configuration).ezsigntemplatepackagemembershipGetObjectV3(pkiEzsigntemplatepackagemembershipID, options).then((request) => request(this.axios, this.basePath));
    }
}
