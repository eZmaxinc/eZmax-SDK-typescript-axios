...
// @ts-ignore
import type { EzsigntemplatedocumentEditEzsigntemplatesignaturesV2Request } from '../model';
// @ts-ignore
import type { EzsigntemplatedocumentEditEzsigntemplatesignaturesV2Response } from '../model';
// @ts-ignore
...
export const ObjectEzsigntemplatedocumentApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @summary Edit multiple Ezsigntemplatesignatures
         * @param {number} pkiEzsigntemplatedocumentID 
         * @param {EzsigntemplatedocumentEditEzsigntemplatesignaturesV2Request} ezsigntemplatedocumentEditEzsigntemplatesignaturesV2Request 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        ezsigntemplatedocumentEditEzsigntemplatesignaturesV2: async (pkiEzsigntemplatedocumentID: number, ezsigntemplatedocumentEditEzsigntemplatesignaturesV2Request: EzsigntemplatedocumentEditEzsigntemplatesignaturesV2Request, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsigntemplatedocumentID' is not null or undefined
            assertParamExists('ezsigntemplatedocumentEditEzsigntemplatesignaturesV2', 'pkiEzsigntemplatedocumentID', pkiEzsigntemplatedocumentID)
            ...
            //localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.headers = {...headersFromBaseOptions, ...localVarHeaderParameter,  ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(ezsigntemplatedocumentEditEzsigntemplatesignaturesV2Request, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatedocumentGetEzsigntemplatesignaturesV2: async (pkiEzsigntemplatedocumentID: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsigntemplatedocumentID' is not null or undefined
...
export const ObjectEzsigntemplatedocumentApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async ezsigntemplatedocumentEditEzsigntemplatesignaturesV2(pkiEzsigntemplatedocumentID: number, ezsigntemplatedocumentEditEzsigntemplatesignaturesV2Request: EzsigntemplatedocumentEditEzsigntemplatesignaturesV2Request, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsigntemplatedocumentEditEzsigntemplatesignaturesV2Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsigntemplatedocumentEditEzsigntemplatesignaturesV2(pkiEzsigntemplatedocumentID, ezsigntemplatedocumentEditEzsigntemplatesignaturesV2Request, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsigntemplatedocumentApi.ezsigntemplatedocumentEditEzsigntemplatesignaturesV2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async ezsigntemplatedocumentGetEzsigntemplatesignaturesV2(pkiEzsigntemplatedocumentID: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsigntemplatedocumentGetEzsigntemplatesignaturesV2Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsigntemplatedocumentGetEzsigntemplatesignaturesV2(pkiEzsigntemplatedocumentID, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsigntemplatedocumentApi.ezsigntemplatedocumentGetEzsigntemplatesignaturesV2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const ObjectEzsigntemplatedocumentApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatedocumentEditEzsigntemplatesignaturesV2(pkiEzsigntemplatedocumentID: number, ezsigntemplatedocumentEditEzsigntemplatesignaturesV2Request: EzsigntemplatedocumentEditEzsigntemplatesignaturesV2Request, options?: RawAxiosRequestConfig): AxiosPromise<EzsigntemplatedocumentEditEzsigntemplatesignaturesV2Response> {
            return localVarFp.ezsigntemplatedocumentEditEzsigntemplatesignaturesV2(pkiEzsigntemplatedocumentID, ezsigntemplatedocumentEditEzsigntemplatesignaturesV2Request, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Edit an existing Ezsigntemplatedocument
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatedocumentGetEzsigntemplatesignaturesV2(pkiEzsigntemplatedocumentID: number, options?: RawAxiosRequestConfig): AxiosPromise<EzsigntemplatedocumentGetEzsigntemplatesignaturesV2Response> {
            return localVarFp.ezsigntemplatedocumentGetEzsigntemplatesignaturesV2(pkiEzsigntemplatedocumentID, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Retrieve an existing Ezsigntemplatedocument
...
export class ObjectEzsigntemplatedocumentApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public ezsigntemplatedocumentEditEzsigntemplatesignaturesV2(pkiEzsigntemplatedocumentID: number, ezsigntemplatedocumentEditEzsigntemplatesignaturesV2Request: EzsigntemplatedocumentEditEzsigntemplatesignaturesV2Request, options?: RawAxiosRequestConfig) {
        return ObjectEzsigntemplatedocumentApiFp(this.configuration).ezsigntemplatedocumentEditEzsigntemplatesignaturesV2(pkiEzsigntemplatedocumentID, ezsigntemplatedocumentEditEzsigntemplatesignaturesV2Request, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public ezsigntemplatedocumentGetEzsigntemplatesignaturesV2(pkiEzsigntemplatedocumentID: number, options?: RawAxiosRequestConfig) {
        return ObjectEzsigntemplatedocumentApiFp(this.configuration).ezsigntemplatedocumentGetEzsigntemplatesignaturesV2(pkiEzsigntemplatedocumentID, options).then((request) => request(this.axios, this.basePath));
    }
