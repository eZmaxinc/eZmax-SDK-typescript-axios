...
export const ObjectPaymenttermApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async paymenttermEditObjectV1(pkiPaymenttermID: number, paymenttermEditObjectV1Request: PaymenttermEditObjectV1Request, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResponse>> {
...
export const ObjectPaymenttermApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        paymenttermEditObjectV1(pkiPaymenttermID: number, paymenttermEditObjectV1Request: PaymenttermEditObjectV1Request, options?: RawAxiosRequestConfig): AxiosPromise<CommonResponse> {
