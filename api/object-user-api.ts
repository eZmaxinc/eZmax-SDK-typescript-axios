...
export const ObjectUserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {'pkiUserID_ASC' | 'pkiUserID_DESC' | 'sUserFirstname_ASC' | 'sUserFirstname_DESC' | 'sUserLastname_ASC' | 'sUserLastname_DESC' | 'sUserLoginname_ASC' | 'sUserLoginname_DESC' | 'bUserIsactive_ASC' | 'bUserIsactive_DESC' | 'eUserType_ASC' | 'eUserType_DESC' | 'eUserOrigin_ASC' | 'eUserOrigin_DESC' | 'eUserEzsignaccess_ASC' | 'eUserEzsignaccess_DESC' | 'dtUserEzsignprepaidexpiration_ASC' | 'dtUserEzsignprepaidexpiration_DESC' | 'sEmailAddress_ASC' | 'sEmailAddress_DESC'} [eOrderBy] Specify how you want the results to be sorted
         ...
         * @throws {RequiredError}
         */
        userGetListV1: async (eOrderBy?: 'pkiUserID_ASC' | 'pkiUserID_DESC' | 'sUserFirstname_ASC' | 'sUserFirstname_DESC' | 'sUserLastname_ASC' | 'sUserLastname_DESC' | 'sUserLoginname_ASC' | 'sUserLoginname_DESC' | 'bUserIsactive_ASC' | 'bUserIsactive_DESC' | 'eUserType_ASC' | 'eUserType_DESC' | 'eUserOrigin_ASC' | 'eUserOrigin_DESC' | 'eUserEzsignaccess_ASC' | 'eUserEzsignaccess_DESC' | 'dtUserEzsignprepaidexpiration_ASC' | 'dtUserEzsignprepaidexpiration_DESC' | 'sEmailAddress_ASC' | 'sEmailAddress_DESC', iRowMax?: number, iRowOffset?: number, acceptLanguage?: HeaderAcceptLanguage, sFilter?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ObjectUserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async userGetListV1(eOrderBy?: 'pkiUserID_ASC' | 'pkiUserID_DESC' | 'sUserFirstname_ASC' | 'sUserFirstname_DESC' | 'sUserLastname_ASC' | 'sUserLastname_DESC' | 'sUserLoginname_ASC' | 'sUserLoginname_DESC' | 'bUserIsactive_ASC' | 'bUserIsactive_DESC' | 'eUserType_ASC' | 'eUserType_DESC' | 'eUserOrigin_ASC' | 'eUserOrigin_DESC' | 'eUserEzsignaccess_ASC' | 'eUserEzsignaccess_DESC' | 'dtUserEzsignprepaidexpiration_ASC' | 'dtUserEzsignprepaidexpiration_DESC' | 'sEmailAddress_ASC' | 'sEmailAddress_DESC', iRowMax?: number, iRowOffset?: number, acceptLanguage?: HeaderAcceptLanguage, sFilter?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserGetListV1Response>> {
...
export const ObjectUserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        userGetListV1(eOrderBy?: 'pkiUserID_ASC' | 'pkiUserID_DESC' | 'sUserFirstname_ASC' | 'sUserFirstname_DESC' | 'sUserLastname_ASC' | 'sUserLastname_DESC' | 'sUserLoginname_ASC' | 'sUserLoginname_DESC' | 'bUserIsactive_ASC' | 'bUserIsactive_DESC' | 'eUserType_ASC' | 'eUserType_DESC' | 'eUserOrigin_ASC' | 'eUserOrigin_DESC' | 'eUserEzsignaccess_ASC' | 'eUserEzsignaccess_DESC' | 'dtUserEzsignprepaidexpiration_ASC' | 'dtUserEzsignprepaidexpiration_DESC' | 'sEmailAddress_ASC' | 'sEmailAddress_DESC', iRowMax?: number, iRowOffset?: number, acceptLanguage?: HeaderAcceptLanguage, sFilter?: string, options?: any): AxiosPromise<UserGetListV1Response> {
...
export class ObjectUserApi extends BaseAPI {
     ...
     * @memberof ObjectUserApi
     */
    public userGetListV1(eOrderBy?: 'pkiUserID_ASC' | 'pkiUserID_DESC' | 'sUserFirstname_ASC' | 'sUserFirstname_DESC' | 'sUserLastname_ASC' | 'sUserLastname_DESC' | 'sUserLoginname_ASC' | 'sUserLoginname_DESC' | 'bUserIsactive_ASC' | 'bUserIsactive_DESC' | 'eUserType_ASC' | 'eUserType_DESC' | 'eUserOrigin_ASC' | 'eUserOrigin_DESC' | 'eUserEzsignaccess_ASC' | 'eUserEzsignaccess_DESC' | 'dtUserEzsignprepaidexpiration_ASC' | 'dtUserEzsignprepaidexpiration_DESC' | 'sEmailAddress_ASC' | 'sEmailAddress_DESC', iRowMax?: number, iRowOffset?: number, acceptLanguage?: HeaderAcceptLanguage, sFilter?: string, options?: AxiosRequestConfig) {
