...
// @ts-ignore
import type { InvoiceImportIntoEDMV1Request } from '../model';
// @ts-ignore
import type { InvoiceImportIntoEDMV1Response } from '../model';
// @ts-ignore
...
export const ObjectInvoiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {number} pkiInvoiceID 
         * @param {InvoiceImportIntoEDMV1Request} invoiceImportIntoEDMV1Request 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        invoiceImportIntoEDMV1: async (pkiInvoiceID: number, invoiceImportIntoEDMV1Request: InvoiceImportIntoEDMV1Request, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiInvoiceID' is not null or undefined
            assertParamExists('invoiceImportIntoEDMV1', 'pkiInvoiceID', pkiInvoiceID)
            // verify required parameter 'invoiceImportIntoEDMV1Request' is not null or undefined
            assertParamExists('invoiceImportIntoEDMV1', 'invoiceImportIntoEDMV1Request', invoiceImportIntoEDMV1Request)
            const localVarPath = `/1/object/invoice/{pkiInvoiceID}/importIntoEDM`
                .replace(`{${"pkiInvoiceID"}}`, encodeURIComponent(String(pkiInvoiceID)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            let basePath = DUMMY_BASE_URL
            if (configuration && configuration.basePath) basePath = configuration.basePath
            ...
            //localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.headers = {...headersFromBaseOptions, ...localVarHeaderParameter,  ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(invoiceImportIntoEDMV1Request, localVarRequestOptions, configuration)
...
export const ObjectInvoiceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async invoiceImportIntoEDMV1(pkiInvoiceID: number, invoiceImportIntoEDMV1Request: InvoiceImportIntoEDMV1Request, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InvoiceImportIntoEDMV1Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.invoiceImportIntoEDMV1(pkiInvoiceID, invoiceImportIntoEDMV1Request, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectInvoiceApi.invoiceImportIntoEDMV1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const ObjectInvoiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        invoiceImportIntoEDMV1(pkiInvoiceID: number, invoiceImportIntoEDMV1Request: InvoiceImportIntoEDMV1Request, options?: RawAxiosRequestConfig): AxiosPromise<InvoiceImportIntoEDMV1Response> {
            return localVarFp.invoiceImportIntoEDMV1(pkiInvoiceID, invoiceImportIntoEDMV1Request, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ObjectInvoiceApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public invoiceImportIntoEDMV1(pkiInvoiceID: number, invoiceImportIntoEDMV1Request: InvoiceImportIntoEDMV1Request, options?: RawAxiosRequestConfig) {
        return ObjectInvoiceApiFp(this.configuration).invoiceImportIntoEDMV1(pkiInvoiceID, invoiceImportIntoEDMV1Request, options).then((request) => request(this.axios, this.basePath));
    }
}
