...
// @ts-ignore
import type { SystemconfigurationEditObjectV2Request } from '../model';
// @ts-ignore
import type { SystemconfigurationEditObjectV2Response } from '../model';
// @ts-ignore
...
export const ObjectSystemconfigurationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {SystemconfigurationEditObjectV2Request} systemconfigurationEditObjectV2Request 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        systemconfigurationEditObjectV2: async (pkiSystemconfigurationID: number, systemconfigurationEditObjectV2Request: SystemconfigurationEditObjectV2Request, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiSystemconfigurationID' is not null or undefined
            assertParamExists('systemconfigurationEditObjectV2', 'pkiSystemconfigurationID', pkiSystemconfigurationID)
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(systemconfigurationEditObjectV2Request, localVarRequestOptions, configuration)
...
export const ObjectSystemconfigurationApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async systemconfigurationEditObjectV2(pkiSystemconfigurationID: number, systemconfigurationEditObjectV2Request: SystemconfigurationEditObjectV2Request, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SystemconfigurationEditObjectV2Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.systemconfigurationEditObjectV2(pkiSystemconfigurationID, systemconfigurationEditObjectV2Request, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectSystemconfigurationApi.systemconfigurationEditObjectV2']?.[localVarOperationServerIndex]?.url;
...
export const ObjectSystemconfigurationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        systemconfigurationEditObjectV2(pkiSystemconfigurationID: number, systemconfigurationEditObjectV2Request: SystemconfigurationEditObjectV2Request, options?: RawAxiosRequestConfig): AxiosPromise<SystemconfigurationEditObjectV2Response> {
            return localVarFp.systemconfigurationEditObjectV2(pkiSystemconfigurationID, systemconfigurationEditObjectV2Request, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Retrieve an existing Systemconfiguration
...
export class ObjectSystemconfigurationApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public systemconfigurationEditObjectV2(pkiSystemconfigurationID: number, systemconfigurationEditObjectV2Request: SystemconfigurationEditObjectV2Request, options?: RawAxiosRequestConfig) {
        return ObjectSystemconfigurationApiFp(this.configuration).systemconfigurationEditObjectV2(pkiSystemconfigurationID, systemconfigurationEditObjectV2Request, options).then((request) => request(this.axios, this.basePath));
    }
