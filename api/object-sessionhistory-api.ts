...
// @ts-ignore
import type { SessionhistoryGetListV1Response } from '../model';
// @ts-ignore
...
export const ObjectSessionhistoryApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        sessionhistoryGetListV1(eOrderBy?: SessionhistoryGetListV1EOrderByEnum, iRowMax?: number, iRowOffset?: number, acceptLanguage?: HeaderAcceptLanguage, sFilter?: string, options?: RawAxiosRequestConfig): AxiosPromise<SessionhistoryGetListV1Response> {
