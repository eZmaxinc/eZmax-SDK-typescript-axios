...
// @ts-ignore
import type { SupplyDeleteObjectV1Response } from '../model';
// @ts-ignore
import type { SupplyEditObjectV1Request } from '../model';
// @ts-ignore
import type { SupplyEditObjectV1Response } from '../model';
// @ts-ignore
...
export const ObjectSupplyApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        supplyDeleteObjectV1(pkiSupplyID: number, options?: RawAxiosRequestConfig): AxiosPromise<SupplyDeleteObjectV1Response> {
         ...
         * @throws {RequiredError}
         */
        supplyEditObjectV1(pkiSupplyID: number, supplyEditObjectV1Request: SupplyEditObjectV1Request, options?: RawAxiosRequestConfig): AxiosPromise<SupplyEditObjectV1Response> {
