...
// @ts-ignore
import type { EzmaxinvoicingGetAutocompleteV2Response } from '../model';
// @ts-ignore
import type { EzmaxinvoicingGetObjectV2Response } from '../model';
// @ts-ignore
import type { EzmaxinvoicingGetProvisionalV1Response } from '../model';
// @ts-ignore
...
export const ObjectEzmaxinvoicingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        ezmaxinvoicingGetAutocompleteV2(sSelector: EzmaxinvoicingGetAutocompleteV2SSelectorEnum, eFilterActive?: EzmaxinvoicingGetAutocompleteV2EFilterActiveEnum, sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: RawAxiosRequestConfig): AxiosPromise<EzmaxinvoicingGetAutocompleteV2Response> {
         ...
         * @throws {RequiredError}
         */
        ezmaxinvoicingGetObjectV2(pkiEzmaxinvoicingID: number, options?: RawAxiosRequestConfig): AxiosPromise<EzmaxinvoicingGetObjectV2Response> {
         ...
         * @throws {RequiredError}
         */
        ezmaxinvoicingGetProvisionalV1(options?: RawAxiosRequestConfig): AxiosPromise<EzmaxinvoicingGetProvisionalV1Response> {
