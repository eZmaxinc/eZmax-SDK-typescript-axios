...
// @ts-ignore
import type { TimezoneGetAutocompleteV2Response } from '../model';
// @ts-ignore
...
export const ObjectTimezoneApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        timezoneGetAutocompleteV2(sSelector: TimezoneGetAutocompleteV2SSelectorEnum, eFilterActive?: TimezoneGetAutocompleteV2EFilterActiveEnum, sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: RawAxiosRequestConfig): AxiosPromise<TimezoneGetAutocompleteV2Response> {
