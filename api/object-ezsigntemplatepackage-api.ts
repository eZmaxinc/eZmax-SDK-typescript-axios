...
export const ObjectEzsigntemplatepackageApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepackageGetAutocompleteV1: async (sSelector: 'All' | 'AllMultipleCopiesDisabled', eFilterActive?: 'All' | 'Active' | 'Inactive', sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepackageGetAutocompleteV2: async (sSelector: 'All' | 'AllMultipleCopiesDisabled', eFilterActive?: 'All' | 'Active' | 'Inactive', sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'sSelector' is not null or undefined
...
export const ObjectEzsigntemplatepackageApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async ezsigntemplatepackageGetAutocompleteV1(sSelector: 'All' | 'AllMultipleCopiesDisabled', eFilterActive?: 'All' | 'Active' | 'Inactive', sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonGetAutocompleteDisabledV1Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsigntemplatepackageGetAutocompleteV1(sSelector, eFilterActive, sQuery, acceptLanguage, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get the list of Ezsigntemplatepackage to be used in a dropdown or autocomplete control.
         ...
         * @throws {RequiredError}
         */
        async ezsigntemplatepackageGetAutocompleteV2(sSelector: 'All' | 'AllMultipleCopiesDisabled', eFilterActive?: 'All' | 'Active' | 'Inactive', sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsigntemplatepackageGetAutocompleteV2Response>> {
...
export const ObjectEzsigntemplatepackageApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepackageGetAutocompleteV1(sSelector: 'All' | 'AllMultipleCopiesDisabled', eFilterActive?: 'All' | 'Active' | 'Inactive', sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: any): AxiosPromise<CommonGetAutocompleteDisabledV1Response> {
            return localVarFp.ezsigntemplatepackageGetAutocompleteV1(sSelector, eFilterActive, sQuery, acceptLanguage, options).then((request) => request(axios, basePath));
        },
        /**
         * Get the list of Ezsigntemplatepackage to be used in a dropdown or autocomplete control.
         * @summary Retrieve Ezsigntemplatepackages and IDs
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepackageGetAutocompleteV2(sSelector: 'All' | 'AllMultipleCopiesDisabled', eFilterActive?: 'All' | 'Active' | 'Inactive', sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: any): AxiosPromise<EzsigntemplatepackageGetAutocompleteV2Response> {
...
export class ObjectEzsigntemplatepackageApi extends BaseAPI {
     ...
     * @memberof ObjectEzsigntemplatepackageApi
     */
    public ezsigntemplatepackageGetAutocompleteV1(sSelector: 'All' | 'AllMultipleCopiesDisabled', eFilterActive?: 'All' | 'Active' | 'Inactive', sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: AxiosRequestConfig) {
        return ObjectEzsigntemplatepackageApiFp(this.configuration).ezsigntemplatepackageGetAutocompleteV1(sSelector, eFilterActive, sQuery, acceptLanguage, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ObjectEzsigntemplatepackageApi
     */
    public ezsigntemplatepackageGetAutocompleteV2(sSelector: 'All' | 'AllMultipleCopiesDisabled', eFilterActive?: 'All' | 'Active' | 'Inactive', sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: AxiosRequestConfig) {
