...
// @ts-ignore
import type { EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Request } from '../model';
// @ts-ignore
import type { EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Response } from '../model';
// @ts-ignore
...
// @ts-ignore
import type { EzsigntemplatepackageGetListV1Response } from '../model';
// @ts-ignore
import type { EzsigntemplatepackageGetObjectV2Response } from '../model';
// @ts-ignore
import type { EzsigntemplatepackageGetObjectV3Response } from '../model';
// @ts-ignore
...
export const ObjectEzsigntemplatepackageApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        ezsigntemplatepackageCreateObjectV1: async (ezsigntemplatepackageCreateObjectV1Request: EzsigntemplatepackageCreateObjectV1Request, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepackageDeleteObjectV1: async (pkiEzsigntemplatepackageID: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepackageEditEzsigntemplatepackagesignersV1: async (pkiEzsigntemplatepackageID: number, ezsigntemplatepackageEditEzsigntemplatepackagesignersV1Request: EzsigntemplatepackageEditEzsigntemplatepackagesignersV1Request, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsigntemplatepackageID' is not null or undefined
         ...
         * @summary Edit multiple Ezsigntemplatepackagesigners
         * @param {number} pkiEzsigntemplatepackageID 
         * @param {EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Request} ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        ezsigntemplatepackageEditEzsigntemplatepackagesignersV2: async (pkiEzsigntemplatepackageID: number, ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request: EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Request, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsigntemplatepackageID' is not null or undefined
            assertParamExists('ezsigntemplatepackageEditEzsigntemplatepackagesignersV2', 'pkiEzsigntemplatepackageID', pkiEzsigntemplatepackageID)
            // verify required parameter 'ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request' is not null or undefined
            assertParamExists('ezsigntemplatepackageEditEzsigntemplatepackagesignersV2', 'ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request', ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request)
            const localVarPath = `/2/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}/editEzsigntemplatepackagesigners`
                .replace('{pkiEzsigntemplatepackageID}', encodeURIComponent(String(pkiEzsigntemplatepackageID)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            let basePath = DUMMY_BASE_URL
            if (configuration && configuration.basePath) basePath = configuration.basePath
            ...
            //localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.headers = {...headersFromBaseOptions, ...localVarHeaderParameter,  ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepackageEditObjectV1: async (pkiEzsigntemplatepackageID: number, ezsigntemplatepackageEditObjectV1Request: EzsigntemplatepackageEditObjectV1Request, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsigntemplatepackageID' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepackageGetListV1: async (eOrderBy?: EzsigntemplatepackageGetListV1EOrderByEnum, iRowMax?: number, iRowOffset?: number, acceptLanguage?: HeaderAcceptLanguage, sFilter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepackageGetObjectV2: async (pkiEzsigntemplatepackageID: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsigntemplatepackageID' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepackageGetObjectV3: async (pkiEzsigntemplatepackageID: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsigntemplatepackageID' is not null or undefined
            assertParamExists('ezsigntemplatepackageGetObjectV3', 'pkiEzsigntemplatepackageID', pkiEzsigntemplatepackageID)
            const localVarPath = `/3/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}`
                .replace('{pkiEzsigntemplatepackageID}', encodeURIComponent(String(pkiEzsigntemplatepackageID)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            let basePath = DUMMY_BASE_URL
            if (configuration && configuration.basePath) basePath = configuration.basePath
...
export const ObjectEzsigntemplatepackageApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async ezsigntemplatepackageCreateObjectV1(ezsigntemplatepackageCreateObjectV1Request: EzsigntemplatepackageCreateObjectV1Request, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsigntemplatepackageCreateObjectV1Response>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsigntemplatepackageApi.ezsigntemplatepackageCreateObjectV1']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async ezsigntemplatepackageEditEzsigntemplatepackagesignersV1(pkiEzsigntemplatepackageID: number, ezsigntemplatepackageEditEzsigntemplatepackagesignersV1Request: EzsigntemplatepackageEditEzsigntemplatepackagesignersV1Request, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsigntemplatepackageEditEzsigntemplatepackagesignersV1Response>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsigntemplatepackageApi.ezsigntemplatepackageEditEzsigntemplatepackagesignersV1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Using this endpoint, you can edit multiple Ezsigntemplatepackagesigners at the same time.
         ...
         * @throws {RequiredError}
         */
        async ezsigntemplatepackageEditEzsigntemplatepackagesignersV2(pkiEzsigntemplatepackageID: number, ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request: EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Request, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsigntemplatepackageEditEzsigntemplatepackagesignersV2(pkiEzsigntemplatepackageID, ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsigntemplatepackageApi.ezsigntemplatepackageEditEzsigntemplatepackagesignersV2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async ezsigntemplatepackageGetListV1(eOrderBy?: EzsigntemplatepackageGetListV1EOrderByEnum, iRowMax?: number, iRowOffset?: number, acceptLanguage?: HeaderAcceptLanguage, sFilter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsigntemplatepackageGetListV1Response>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsigntemplatepackageApi.ezsigntemplatepackageGetListV1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async ezsigntemplatepackageGetObjectV2(pkiEzsigntemplatepackageID: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsigntemplatepackageGetObjectV2Response>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsigntemplatepackageApi.ezsigntemplatepackageGetObjectV2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async ezsigntemplatepackageGetObjectV3(pkiEzsigntemplatepackageID: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsigntemplatepackageGetObjectV3Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsigntemplatepackageGetObjectV3(pkiEzsigntemplatepackageID, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsigntemplatepackageApi.ezsigntemplatepackageGetObjectV3']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const ObjectEzsigntemplatepackageApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepackageCreateObjectV1(ezsigntemplatepackageCreateObjectV1Request: EzsigntemplatepackageCreateObjectV1Request, options?: RawAxiosRequestConfig): AxiosPromise<EzsigntemplatepackageCreateObjectV1Response> {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepackageEditEzsigntemplatepackagesignersV1(pkiEzsigntemplatepackageID: number, ezsigntemplatepackageEditEzsigntemplatepackagesignersV1Request: EzsigntemplatepackageEditEzsigntemplatepackagesignersV1Request, options?: RawAxiosRequestConfig): AxiosPromise<EzsigntemplatepackageEditEzsigntemplatepackagesignersV1Response> {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepackageEditEzsigntemplatepackagesignersV2(pkiEzsigntemplatepackageID: number, ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request: EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Request, options?: RawAxiosRequestConfig): AxiosPromise<EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Response> {
            return localVarFp.ezsigntemplatepackageEditEzsigntemplatepackagesignersV2(pkiEzsigntemplatepackageID, ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Edit an existing Ezsigntemplatepackage
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepackageGetAutocompleteV2(sSelector: EzsigntemplatepackageGetAutocompleteV2SSelectorEnum, eFilterActive?: EzsigntemplatepackageGetAutocompleteV2EFilterActiveEnum, sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, fkiEzsignfoldertypeID?: number, options?: RawAxiosRequestConfig): AxiosPromise<EzsigntemplatepackageGetAutocompleteV2Response> {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepackageGetListV1(eOrderBy?: EzsigntemplatepackageGetListV1EOrderByEnum, iRowMax?: number, iRowOffset?: number, acceptLanguage?: HeaderAcceptLanguage, sFilter?: string, options?: RawAxiosRequestConfig): AxiosPromise<EzsigntemplatepackageGetListV1Response> {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepackageGetObjectV2(pkiEzsigntemplatepackageID: number, options?: RawAxiosRequestConfig): AxiosPromise<EzsigntemplatepackageGetObjectV2Response> {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepackageGetObjectV3(pkiEzsigntemplatepackageID: number, options?: RawAxiosRequestConfig): AxiosPromise<EzsigntemplatepackageGetObjectV3Response> {
            return localVarFp.ezsigntemplatepackageGetObjectV3(pkiEzsigntemplatepackageID, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ObjectEzsigntemplatepackageApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public ezsigntemplatepackageCreateObjectV1(ezsigntemplatepackageCreateObjectV1Request: EzsigntemplatepackageCreateObjectV1Request, options?: RawAxiosRequestConfig) {
     ...
     * @throws {RequiredError}
     */
    public ezsigntemplatepackageDeleteObjectV1(pkiEzsigntemplatepackageID: number, options?: RawAxiosRequestConfig) {
     ...
     * @throws {RequiredError}
     */
    public ezsigntemplatepackageEditEzsigntemplatepackagesignersV1(pkiEzsigntemplatepackageID: number, ezsigntemplatepackageEditEzsigntemplatepackagesignersV1Request: EzsigntemplatepackageEditEzsigntemplatepackagesignersV1Request, options?: RawAxiosRequestConfig) {
     ...
     * @throws {RequiredError}
     */
    public ezsigntemplatepackageEditEzsigntemplatepackagesignersV2(pkiEzsigntemplatepackageID: number, ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request: EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Request, options?: RawAxiosRequestConfig) {
        return ObjectEzsigntemplatepackageApiFp(this.configuration).ezsigntemplatepackageEditEzsigntemplatepackagesignersV2(pkiEzsigntemplatepackageID, ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public ezsigntemplatepackageEditObjectV1(pkiEzsigntemplatepackageID: number, ezsigntemplatepackageEditObjectV1Request: EzsigntemplatepackageEditObjectV1Request, options?: RawAxiosRequestConfig) {
     ...
     * @throws {RequiredError}
     */
    public ezsigntemplatepackageGetListV1(eOrderBy?: EzsigntemplatepackageGetListV1EOrderByEnum, iRowMax?: number, iRowOffset?: number, acceptLanguage?: HeaderAcceptLanguage, sFilter?: string, options?: RawAxiosRequestConfig) {
     ...
     * @throws {RequiredError}
     */
    public ezsigntemplatepackageGetObjectV2(pkiEzsigntemplatepackageID: number, options?: RawAxiosRequestConfig) {
     ...
     * @throws {RequiredError}
     */
    public ezsigntemplatepackageGetObjectV3(pkiEzsigntemplatepackageID: number, options?: RawAxiosRequestConfig) {
        return ObjectEzsigntemplatepackageApiFp(this.configuration).ezsigntemplatepackageGetObjectV3(pkiEzsigntemplatepackageID, options).then((request) => request(this.axios, this.basePath));
    }
}
