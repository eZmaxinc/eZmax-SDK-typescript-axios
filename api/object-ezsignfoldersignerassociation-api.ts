...
// @ts-ignore
import type { EzsignfoldersignerassociationCreateObjectV3Request } from '../model';
// @ts-ignore
import type { EzsignfoldersignerassociationCreateObjectV3Response } from '../model';
// @ts-ignore
import type { EzsignfoldersignerassociationDeleteObjectV1Response } from '../model';
// @ts-ignore
import type { EzsignfoldersignerassociationEditObjectV1Request } from '../model';
// @ts-ignore
import type { EzsignfoldersignerassociationEditObjectV1Response } from '../model';
// @ts-ignore
import type { EzsignfoldersignerassociationEditObjectV2Request } from '../model';
// @ts-ignore
import type { EzsignfoldersignerassociationEditObjectV2Response } from '../model';
// @ts-ignore
import type { EzsignfoldersignerassociationForceDisconnectV1Response } from '../model';
// @ts-ignore
...
// @ts-ignore
import type { EzsignfoldersignerassociationGetObjectV3Response } from '../model';
// @ts-ignore
import type { EzsignfoldersignerassociationPatchObjectV1Request } from '../model';
// @ts-ignore
import type { EzsignfoldersignerassociationPatchObjectV1Response } from '../model';
// @ts-ignore
import type { EzsignfoldersignerassociationReassignV1Request } from '../model';
// @ts-ignore
import type { EzsignfoldersignerassociationReassignV1Response } from '../model';
// @ts-ignore
...
export const ObjectEzsignfoldersignerassociationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationCreateEmbeddedUrlV2: async (pkiEzsignfoldersignerassociationID: number, ezsignfoldersignerassociationCreateEmbeddedUrlV2Request: EzsignfoldersignerassociationCreateEmbeddedUrlV2Request, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsignfoldersignerassociationID' is not null or undefined
            assertParamExists('ezsignfoldersignerassociationCreateEmbeddedUrlV2', 'pkiEzsignfoldersignerassociationID', pkiEzsignfoldersignerassociationID)
            // verify required parameter 'ezsignfoldersignerassociationCreateEmbeddedUrlV2Request' is not null or undefined
            assertParamExists('ezsignfoldersignerassociationCreateEmbeddedUrlV2', 'ezsignfoldersignerassociationCreateEmbeddedUrlV2Request', ezsignfoldersignerassociationCreateEmbeddedUrlV2Request)
            const localVarPath = `/2/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}/createEmbeddedUrl`
                .replace('{pkiEzsignfoldersignerassociationID}', encodeURIComponent(String(pkiEzsignfoldersignerassociationID)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            let basePath = DUMMY_BASE_URL
            if (configuration && configuration.basePath) basePath = configuration.basePath
            ...
            //localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.headers = {...headersFromBaseOptions, ...localVarHeaderParameter,  ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(ezsignfoldersignerassociationCreateEmbeddedUrlV2Request, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationCreateObjectV1: async (ezsignfoldersignerassociationCreateObjectV1Request: Array<EzsignfoldersignerassociationCreateObjectV1Request>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationCreateObjectV2: async (ezsignfoldersignerassociationCreateObjectV2Request: EzsignfoldersignerassociationCreateObjectV2Request, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * The endpoint allows to create one or many elements at once.
         * @summary Create a new Ezsignfoldersignerassociation
         * @param {EzsignfoldersignerassociationCreateObjectV3Request} ezsignfoldersignerassociationCreateObjectV3Request 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationCreateObjectV3: async (ezsignfoldersignerassociationCreateObjectV3Request: EzsignfoldersignerassociationCreateObjectV3Request, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'ezsignfoldersignerassociationCreateObjectV3Request' is not null or undefined
            assertParamExists('ezsignfoldersignerassociationCreateObjectV3', 'ezsignfoldersignerassociationCreateObjectV3Request', ezsignfoldersignerassociationCreateObjectV3Request)
            const localVarPath = `/3/object/ezsignfoldersignerassociation`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            let basePath = DUMMY_BASE_URL
            if (configuration && configuration.basePath) basePath = configuration.basePath
            //const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            //localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.headers = {...headersFromBaseOptions, ...localVarHeaderParameter,  ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(ezsignfoldersignerassociationCreateObjectV3Request, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationDeleteObjectV1: async (pkiEzsignfoldersignerassociationID: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsignfoldersignerassociationID' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationEditObjectV1: async (pkiEzsignfoldersignerassociationID: number, ezsignfoldersignerassociationEditObjectV1Request: EzsignfoldersignerassociationEditObjectV1Request, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsignfoldersignerassociationID' is not null or undefined
         ...
         * @summary Edit an existing Ezsignfoldersignerassociation
         * @param {number} pkiEzsignfoldersignerassociationID 
         * @param {EzsignfoldersignerassociationEditObjectV2Request} ezsignfoldersignerassociationEditObjectV2Request 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationEditObjectV2: async (pkiEzsignfoldersignerassociationID: number, ezsignfoldersignerassociationEditObjectV2Request: EzsignfoldersignerassociationEditObjectV2Request, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsignfoldersignerassociationID' is not null or undefined
            assertParamExists('ezsignfoldersignerassociationEditObjectV2', 'pkiEzsignfoldersignerassociationID', pkiEzsignfoldersignerassociationID)
            // verify required parameter 'ezsignfoldersignerassociationEditObjectV2Request' is not null or undefined
            assertParamExists('ezsignfoldersignerassociationEditObjectV2', 'ezsignfoldersignerassociationEditObjectV2Request', ezsignfoldersignerassociationEditObjectV2Request)
            ...
            //localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.headers = {...headersFromBaseOptions, ...localVarHeaderParameter,  ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(ezsignfoldersignerassociationEditObjectV2Request, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationForceDisconnectV1: async (pkiEzsignfoldersignerassociationID: number, body: object, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsignfoldersignerassociationID' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationGetInPersonLoginUrlV1: async (pkiEzsignfoldersignerassociationID: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsignfoldersignerassociationID' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationGetObjectV1: async (pkiEzsignfoldersignerassociationID: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsignfoldersignerassociationID' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationGetObjectV2: async (pkiEzsignfoldersignerassociationID: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsignfoldersignerassociationID' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationGetObjectV3: async (pkiEzsignfoldersignerassociationID: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsignfoldersignerassociationID' is not null or undefined
            assertParamExists('ezsignfoldersignerassociationGetObjectV3', 'pkiEzsignfoldersignerassociationID', pkiEzsignfoldersignerassociationID)
            const localVarPath = `/3/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}`
                .replace('{pkiEzsignfoldersignerassociationID}', encodeURIComponent(String(pkiEzsignfoldersignerassociationID)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            let basePath = DUMMY_BASE_URL
            if (configuration && configuration.basePath) basePath = configuration.basePath
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationPatchObjectV1: async (pkiEzsignfoldersignerassociationID: number, ezsignfoldersignerassociationPatchObjectV1Request: EzsignfoldersignerassociationPatchObjectV1Request, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsignfoldersignerassociationID' is not null or undefined
...
export const ObjectEzsignfoldersignerassociationApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async ezsignfoldersignerassociationCreateEmbeddedUrlV2(pkiEzsignfoldersignerassociationID: number, ezsignfoldersignerassociationCreateEmbeddedUrlV2Request: EzsignfoldersignerassociationCreateEmbeddedUrlV2Request, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsignfoldersignerassociationCreateEmbeddedUrlV2Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsignfoldersignerassociationCreateEmbeddedUrlV2(pkiEzsignfoldersignerassociationID, ezsignfoldersignerassociationCreateEmbeddedUrlV2Request, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsignfoldersignerassociationApi.ezsignfoldersignerassociationCreateEmbeddedUrlV2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * The endpoint allows to create one or many elements at once.  The array can contain simple (Just the object) or compound (The object and its child) objects.  Creating compound elements allows to reduce the multiple requests to create all child objects.
         ...
         * @throws {RequiredError}
         */
        async ezsignfoldersignerassociationCreateObjectV1(ezsignfoldersignerassociationCreateObjectV1Request: Array<EzsignfoldersignerassociationCreateObjectV1Request>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsignfoldersignerassociationCreateObjectV1Response>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsignfoldersignerassociationApi.ezsignfoldersignerassociationCreateObjectV1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * The endpoint allows to create one or many elements at once.
         ...
         * @throws {RequiredError}
         */
        async ezsignfoldersignerassociationCreateObjectV2(ezsignfoldersignerassociationCreateObjectV2Request: EzsignfoldersignerassociationCreateObjectV2Request, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsignfoldersignerassociationCreateObjectV2Response>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsignfoldersignerassociationApi.ezsignfoldersignerassociationCreateObjectV2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * The endpoint allows to create one or many elements at once.
         ...
         * @throws {RequiredError}
         */
        async ezsignfoldersignerassociationCreateObjectV3(ezsignfoldersignerassociationCreateObjectV3Request: EzsignfoldersignerassociationCreateObjectV3Request, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsignfoldersignerassociationCreateObjectV3Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsignfoldersignerassociationCreateObjectV3(ezsignfoldersignerassociationCreateObjectV3Request, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsignfoldersignerassociationApi.ezsignfoldersignerassociationCreateObjectV3']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async ezsignfoldersignerassociationEditObjectV2(pkiEzsignfoldersignerassociationID: number, ezsignfoldersignerassociationEditObjectV2Request: EzsignfoldersignerassociationEditObjectV2Request, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsignfoldersignerassociationEditObjectV2Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsignfoldersignerassociationEditObjectV2(pkiEzsignfoldersignerassociationID, ezsignfoldersignerassociationEditObjectV2Request, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsignfoldersignerassociationApi.ezsignfoldersignerassociationEditObjectV2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async ezsignfoldersignerassociationGetInPersonLoginUrlV1(pkiEzsignfoldersignerassociationID: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsignfoldersignerassociationGetInPersonLoginUrlV1Response>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsignfoldersignerassociationApi.ezsignfoldersignerassociationGetInPersonLoginUrlV1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async ezsignfoldersignerassociationGetObjectV1(pkiEzsignfoldersignerassociationID: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsignfoldersignerassociationGetObjectV1Response>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsignfoldersignerassociationApi.ezsignfoldersignerassociationGetObjectV1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async ezsignfoldersignerassociationGetObjectV2(pkiEzsignfoldersignerassociationID: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsignfoldersignerassociationGetObjectV2Response>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsignfoldersignerassociationApi.ezsignfoldersignerassociationGetObjectV2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async ezsignfoldersignerassociationGetObjectV3(pkiEzsignfoldersignerassociationID: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsignfoldersignerassociationGetObjectV3Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsignfoldersignerassociationGetObjectV3(pkiEzsignfoldersignerassociationID, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsignfoldersignerassociationApi.ezsignfoldersignerassociationGetObjectV3']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const ObjectEzsignfoldersignerassociationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationCreateEmbeddedUrlV2(pkiEzsignfoldersignerassociationID: number, ezsignfoldersignerassociationCreateEmbeddedUrlV2Request: EzsignfoldersignerassociationCreateEmbeddedUrlV2Request, options?: RawAxiosRequestConfig): AxiosPromise<EzsignfoldersignerassociationCreateEmbeddedUrlV2Response> {
            return localVarFp.ezsignfoldersignerassociationCreateEmbeddedUrlV2(pkiEzsignfoldersignerassociationID, ezsignfoldersignerassociationCreateEmbeddedUrlV2Request, options).then((request) => request(axios, basePath));
        },
        /**
         * The endpoint allows to create one or many elements at once.  The array can contain simple (Just the object) or compound (The object and its child) objects.  Creating compound elements allows to reduce the multiple requests to create all child objects.
         * @summary Create a new Ezsignfoldersignerassociation
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationCreateObjectV3(ezsignfoldersignerassociationCreateObjectV3Request: EzsignfoldersignerassociationCreateObjectV3Request, options?: RawAxiosRequestConfig): AxiosPromise<EzsignfoldersignerassociationCreateObjectV3Response> {
            return localVarFp.ezsignfoldersignerassociationCreateObjectV3(ezsignfoldersignerassociationCreateObjectV3Request, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Delete an existing Ezsignfoldersignerassociation
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationDeleteObjectV1(pkiEzsignfoldersignerassociationID: number, options?: RawAxiosRequestConfig): AxiosPromise<EzsignfoldersignerassociationDeleteObjectV1Response> {
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationEditObjectV1(pkiEzsignfoldersignerassociationID: number, ezsignfoldersignerassociationEditObjectV1Request: EzsignfoldersignerassociationEditObjectV1Request, options?: RawAxiosRequestConfig): AxiosPromise<EzsignfoldersignerassociationEditObjectV1Response> {
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationEditObjectV2(pkiEzsignfoldersignerassociationID: number, ezsignfoldersignerassociationEditObjectV2Request: EzsignfoldersignerassociationEditObjectV2Request, options?: RawAxiosRequestConfig): AxiosPromise<EzsignfoldersignerassociationEditObjectV2Response> {
            return localVarFp.ezsignfoldersignerassociationEditObjectV2(pkiEzsignfoldersignerassociationID, ezsignfoldersignerassociationEditObjectV2Request, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Disconnects the Ezsignfoldersignerassociation
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationForceDisconnectV1(pkiEzsignfoldersignerassociationID: number, body: object, options?: RawAxiosRequestConfig): AxiosPromise<EzsignfoldersignerassociationForceDisconnectV1Response> {
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationGetObjectV3(pkiEzsignfoldersignerassociationID: number, options?: RawAxiosRequestConfig): AxiosPromise<EzsignfoldersignerassociationGetObjectV3Response> {
            return localVarFp.ezsignfoldersignerassociationGetObjectV3(pkiEzsignfoldersignerassociationID, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Patch an existing Ezsignfoldersignerassociation
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationPatchObjectV1(pkiEzsignfoldersignerassociationID: number, ezsignfoldersignerassociationPatchObjectV1Request: EzsignfoldersignerassociationPatchObjectV1Request, options?: RawAxiosRequestConfig): AxiosPromise<EzsignfoldersignerassociationPatchObjectV1Response> {
         ...
         * @throws {RequiredError}
         */
        ezsignfoldersignerassociationReassignV1(pkiEzsignfoldersignerassociationID: number, ezsignfoldersignerassociationReassignV1Request: EzsignfoldersignerassociationReassignV1Request, options?: RawAxiosRequestConfig): AxiosPromise<EzsignfoldersignerassociationReassignV1Response> {
...
export class ObjectEzsignfoldersignerassociationApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public ezsignfoldersignerassociationCreateEmbeddedUrlV2(pkiEzsignfoldersignerassociationID: number, ezsignfoldersignerassociationCreateEmbeddedUrlV2Request: EzsignfoldersignerassociationCreateEmbeddedUrlV2Request, options?: RawAxiosRequestConfig) {
        return ObjectEzsignfoldersignerassociationApiFp(this.configuration).ezsignfoldersignerassociationCreateEmbeddedUrlV2(pkiEzsignfoldersignerassociationID, ezsignfoldersignerassociationCreateEmbeddedUrlV2Request, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public ezsignfoldersignerassociationCreateObjectV1(ezsignfoldersignerassociationCreateObjectV1Request: Array<EzsignfoldersignerassociationCreateObjectV1Request>, options?: RawAxiosRequestConfig) {
     ...
     * @throws {RequiredError}
     */
    public ezsignfoldersignerassociationCreateObjectV2(ezsignfoldersignerassociationCreateObjectV2Request: EzsignfoldersignerassociationCreateObjectV2Request, options?: RawAxiosRequestConfig) {
     ...
     * @throws {RequiredError}
     */
    public ezsignfoldersignerassociationCreateObjectV3(ezsignfoldersignerassociationCreateObjectV3Request: EzsignfoldersignerassociationCreateObjectV3Request, options?: RawAxiosRequestConfig) {
        return ObjectEzsignfoldersignerassociationApiFp(this.configuration).ezsignfoldersignerassociationCreateObjectV3(ezsignfoldersignerassociationCreateObjectV3Request, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public ezsignfoldersignerassociationDeleteObjectV1(pkiEzsignfoldersignerassociationID: number, options?: RawAxiosRequestConfig) {
     ...
     * @throws {RequiredError}
     */
    public ezsignfoldersignerassociationEditObjectV1(pkiEzsignfoldersignerassociationID: number, ezsignfoldersignerassociationEditObjectV1Request: EzsignfoldersignerassociationEditObjectV1Request, options?: RawAxiosRequestConfig) {
     ...
     * @throws {RequiredError}
     */
    public ezsignfoldersignerassociationEditObjectV2(pkiEzsignfoldersignerassociationID: number, ezsignfoldersignerassociationEditObjectV2Request: EzsignfoldersignerassociationEditObjectV2Request, options?: RawAxiosRequestConfig) {
        return ObjectEzsignfoldersignerassociationApiFp(this.configuration).ezsignfoldersignerassociationEditObjectV2(pkiEzsignfoldersignerassociationID, ezsignfoldersignerassociationEditObjectV2Request, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public ezsignfoldersignerassociationForceDisconnectV1(pkiEzsignfoldersignerassociationID: number, body: object, options?: RawAxiosRequestConfig) {
     ...
     * @throws {RequiredError}
     */
    public ezsignfoldersignerassociationGetInPersonLoginUrlV1(pkiEzsignfoldersignerassociationID: number, options?: RawAxiosRequestConfig) {
     ...
     * @throws {RequiredError}
     */
    public ezsignfoldersignerassociationGetObjectV1(pkiEzsignfoldersignerassociationID: number, options?: RawAxiosRequestConfig) {
     ...
     * @throws {RequiredError}
     */
    public ezsignfoldersignerassociationGetObjectV2(pkiEzsignfoldersignerassociationID: number, options?: RawAxiosRequestConfig) {
     ...
     * @throws {RequiredError}
     */
    public ezsignfoldersignerassociationGetObjectV3(pkiEzsignfoldersignerassociationID: number, options?: RawAxiosRequestConfig) {
        return ObjectEzsignfoldersignerassociationApiFp(this.configuration).ezsignfoldersignerassociationGetObjectV3(pkiEzsignfoldersignerassociationID, options).then((request) => request(this.axios, this.basePath));
    }
