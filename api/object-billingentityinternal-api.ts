...
// @ts-ignore
import type { BillingentityinternalCreateObjectV1Request } from '../model';
// @ts-ignore
import type { BillingentityinternalCreateObjectV1Response } from '../model';
// @ts-ignore
...
export const ObjectBillingentityinternalApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        billingentityinternalCreateObjectV1(billingentityinternalCreateObjectV1Request: BillingentityinternalCreateObjectV1Request, options?: RawAxiosRequestConfig): AxiosPromise<BillingentityinternalCreateObjectV1Response> {
         ...
         * @throws {RequiredError}
         */
        billingentityinternalGetAutocompleteV2(sSelector: BillingentityinternalGetAutocompleteV2SSelectorEnum, eFilterActive?: BillingentityinternalGetAutocompleteV2EFilterActiveEnum, sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: RawAxiosRequestConfig): AxiosPromise<BillingentityinternalGetAutocompleteV2Response> {
         ...
         * @throws {RequiredError}
         */
        billingentityinternalGetListV1(eOrderBy?: BillingentityinternalGetListV1EOrderByEnum, iRowMax?: number, iRowOffset?: number, acceptLanguage?: HeaderAcceptLanguage, sFilter?: string, options?: RawAxiosRequestConfig): AxiosPromise<BillingentityinternalGetListV1Response> {
         ...
         * @throws {RequiredError}
         */
        billingentityinternalGetObjectV2(pkiBillingentityinternalID: number, options?: RawAxiosRequestConfig): AxiosPromise<BillingentityinternalGetObjectV2Response> {
