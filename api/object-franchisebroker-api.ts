...
// @ts-ignore
import type { FranchisebrokerGetAutocompleteV2Response } from '../model';
// @ts-ignore
...
export const ObjectFranchisebrokerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        franchisebrokerGetAutocompleteV2(sSelector: FranchisebrokerGetAutocompleteV2SSelectorEnum, eFilterActive?: FranchisebrokerGetAutocompleteV2EFilterActiveEnum, sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: RawAxiosRequestConfig): AxiosPromise<FranchisebrokerGetAutocompleteV2Response> {
