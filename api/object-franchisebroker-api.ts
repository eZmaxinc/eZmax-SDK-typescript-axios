...
export const ObjectFranchisebrokerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {FranchisebrokerGetAutocompleteV1SSelectorEnum} sSelector The type of Franchisebrokers to return
         * @param {FranchisebrokerGetAutocompleteV1EFilterActiveEnum} [eFilterActive] Specify which results we want to display.
         ...
         */
        franchisebrokerGetAutocompleteV1: async (sSelector: FranchisebrokerGetAutocompleteV1SSelectorEnum, eFilterActive?: FranchisebrokerGetAutocompleteV1EFilterActiveEnum, sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ObjectFranchisebrokerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async franchisebrokerGetAutocompleteV1(sSelector: FranchisebrokerGetAutocompleteV1SSelectorEnum, eFilterActive?: FranchisebrokerGetAutocompleteV1EFilterActiveEnum, sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonGetAutocompleteV1Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.franchisebrokerGetAutocompleteV1(sSelector, eFilterActive, sQuery, acceptLanguage, options);
...
export const ObjectFranchisebrokerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        franchisebrokerGetAutocompleteV1(sSelector: FranchisebrokerGetAutocompleteV1SSelectorEnum, eFilterActive?: FranchisebrokerGetAutocompleteV1EFilterActiveEnum, sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: any): AxiosPromise<CommonGetAutocompleteV1Response> {
            return localVarFp.franchisebrokerGetAutocompleteV1(sSelector, eFilterActive, sQuery, acceptLanguage, options).then((request) => request(axios, basePath));
        },
        /**
         * Get the list of Franchisebroker to be used in a dropdown or autocomplete control.
         * @summary Retrieve Franchisebrokers and IDs
...
export class ObjectFranchisebrokerApi extends BaseAPI {
     ...
     */
    public franchisebrokerGetAutocompleteV1(sSelector: FranchisebrokerGetAutocompleteV1SSelectorEnum, eFilterActive?: FranchisebrokerGetAutocompleteV1EFilterActiveEnum, sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: AxiosRequestConfig) {
        return ObjectFranchisebrokerApiFp(this.configuration).franchisebrokerGetAutocompleteV1(sSelector, eFilterActive, sQuery, acceptLanguage, options).then((request) => request(this.axios, this.basePath));
    }
 ...
 * @export
 */
export const FranchisebrokerGetAutocompleteV1SSelectorEnum = {
    Active: 'Active',
    All: 'All'
} as const;
export type FranchisebrokerGetAutocompleteV1SSelectorEnum = typeof FranchisebrokerGetAutocompleteV1SSelectorEnum[keyof typeof FranchisebrokerGetAutocompleteV1SSelectorEnum];
/**
 * @export
 */
export const FranchisebrokerGetAutocompleteV1EFilterActiveEnum = {
    All: 'All',
    Active: 'Active',
    Inactive: 'Inactive'
} as const;
export type FranchisebrokerGetAutocompleteV1EFilterActiveEnum = typeof FranchisebrokerGetAutocompleteV1EFilterActiveEnum[keyof typeof FranchisebrokerGetAutocompleteV1EFilterActiveEnum];
/**
 * @export
 */
