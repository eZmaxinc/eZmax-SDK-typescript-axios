...
export const ModuleEzsignApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        ezsignSuggestSignersV1: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        ezsignSuggestTemplatesV1: async (fkiEzsignfoldertypeID?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ModuleEzsignApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async ezsignSuggestSignersV1(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsignSuggestSignersV1Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsignSuggestSignersV1(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ModuleEzsignApi.ezsignSuggestSignersV1']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async ezsignSuggestTemplatesV1(fkiEzsignfoldertypeID?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsignSuggestTemplatesV1Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsignSuggestTemplatesV1(fkiEzsignfoldertypeID, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ModuleEzsignApi.ezsignSuggestTemplatesV1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export class ModuleEzsignApi extends BaseAPI {
     ...
     */
    public ezsignSuggestSignersV1(options?: RawAxiosRequestConfig) {
     ...
     * @memberof ModuleEzsignApi
     */
    public ezsignSuggestTemplatesV1(fkiEzsignfoldertypeID?: number, options?: RawAxiosRequestConfig) {
