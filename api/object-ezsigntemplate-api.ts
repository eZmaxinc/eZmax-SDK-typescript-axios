...
// @ts-ignore
import type { EzsigntemplateDeleteObjectV1Response } from '../model';
// @ts-ignore
import type { EzsigntemplateEditObjectV3Request } from '../model';
// @ts-ignore
import type { EzsigntemplateEditObjectV3Response } from '../model';
// @ts-ignore
...
// @ts-ignore
import type { EzsigntemplateGetObjectV4Response } from '../model';
// @ts-ignore
...
export const ObjectEzsigntemplateApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplateGetObjectV4: async (pkiEzsigntemplateID: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsigntemplateID' is not null or undefined
            assertParamExists('ezsigntemplateGetObjectV4', 'pkiEzsigntemplateID', pkiEzsigntemplateID)
            const localVarPath = `/4/object/ezsigntemplate/{pkiEzsigntemplateID}`
                .replace('{pkiEzsigntemplateID}', encodeURIComponent(String(pkiEzsigntemplateID)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            let basePath = DUMMY_BASE_URL
            if (configuration && configuration.basePath) basePath = configuration.basePath
...
export const ObjectEzsigntemplateApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async ezsigntemplateEditObjectV3(pkiEzsigntemplateID: number, ezsigntemplateEditObjectV3Request: EzsigntemplateEditObjectV3Request, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsigntemplateEditObjectV3Response>> {
         ...
         * @throws {RequiredError}
         */
        async ezsigntemplateGetObjectV4(pkiEzsigntemplateID: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsigntemplateGetObjectV4Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsigntemplateGetObjectV4(pkiEzsigntemplateID, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsigntemplateApi.ezsigntemplateGetObjectV4']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const ObjectEzsigntemplateApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplateDeleteObjectV1(pkiEzsigntemplateID: number, options?: RawAxiosRequestConfig): AxiosPromise<EzsigntemplateDeleteObjectV1Response> {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplateEditObjectV3(pkiEzsigntemplateID: number, ezsigntemplateEditObjectV3Request: EzsigntemplateEditObjectV3Request, options?: RawAxiosRequestConfig): AxiosPromise<EzsigntemplateEditObjectV3Response> {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplateGetObjectV4(pkiEzsigntemplateID: number, options?: RawAxiosRequestConfig): AxiosPromise<EzsigntemplateGetObjectV4Response> {
            return localVarFp.ezsigntemplateGetObjectV4(pkiEzsigntemplateID, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ObjectEzsigntemplateApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public ezsigntemplateGetObjectV4(pkiEzsigntemplateID: number, options?: RawAxiosRequestConfig) {
        return ObjectEzsigntemplateApiFp(this.configuration).ezsigntemplateGetObjectV4(pkiEzsigntemplateID, options).then((request) => request(this.axios, this.basePath));
    }
}
