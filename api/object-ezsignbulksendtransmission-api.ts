...
export const ObjectEzsignbulksendtransmissionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        ezsignbulksendtransmissionGetBatchFileV1: async (pkiEzsignbulksendtransmissionID: number, bIncludeSigned?: boolean, bIncludeAttachment?: boolean, bIncludeProofdocument?: boolean, bIncludeProof?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsignbulksendtransmissionID' is not null or undefined
            assertParamExists('ezsignbulksendtransmissionGetBatchFileV1', 'pkiEzsignbulksendtransmissionID', pkiEzsignbulksendtransmissionID)
            const localVarPath = `/1/object/ezsignbulksendtransmission/{pkiEzsignbulksendtransmissionID}/getBatchFile`
...
export const ObjectEzsignbulksendtransmissionApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async ezsignbulksendtransmissionGetBatchFileV1(pkiEzsignbulksendtransmissionID: number, bIncludeSigned?: boolean, bIncludeAttachment?: boolean, bIncludeProofdocument?: boolean, bIncludeProof?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsignbulksendtransmissionGetBatchFileV1(pkiEzsignbulksendtransmissionID, bIncludeSigned, bIncludeAttachment, bIncludeProofdocument, bIncludeProof, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsignbulksendtransmissionApi.ezsignbulksendtransmissionGetBatchFileV1']?.[localVarOperationServerIndex]?.url;
...
export const ObjectEzsignbulksendtransmissionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        ezsignbulksendtransmissionGetBatchFileV1(pkiEzsignbulksendtransmissionID: number, bIncludeSigned?: boolean, bIncludeAttachment?: boolean, bIncludeProofdocument?: boolean, bIncludeProof?: boolean, options?: RawAxiosRequestConfig): AxiosPromise<File> {
            return localVarFp.ezsignbulksendtransmissionGetBatchFileV1(pkiEzsignbulksendtransmissionID, bIncludeSigned, bIncludeAttachment, bIncludeProofdocument, bIncludeProof, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Retrieve an existing Ezsignbulksendtransmission\'s Csv containing errors
...
export class ObjectEzsignbulksendtransmissionApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public ezsignbulksendtransmissionGetBatchFileV1(pkiEzsignbulksendtransmissionID: number, bIncludeSigned?: boolean, bIncludeAttachment?: boolean, bIncludeProofdocument?: boolean, bIncludeProof?: boolean, options?: RawAxiosRequestConfig) {
        return ObjectEzsignbulksendtransmissionApiFp(this.configuration).ezsignbulksendtransmissionGetBatchFileV1(pkiEzsignbulksendtransmissionID, bIncludeSigned, bIncludeAttachment, bIncludeProofdocument, bIncludeProof, options).then((request) => request(this.axios, this.basePath));
    }
