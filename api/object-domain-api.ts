...
// @ts-ignore
import type { DomainGetAutocompleteV2Response } from '../model';
// @ts-ignore
...
export const ObjectDomainApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {DomainGetAutocompleteV2SSelectorEnum} sSelector The type of Domain to return
         * @param {DomainGetAutocompleteV2EFilterActiveEnum} [eFilterActive] Specify which results we want to display.
         * @param {string} [sQuery] Allow to filter the returned results
         * @param {HeaderAcceptLanguage} [acceptLanguage] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        domainGetAutocompleteV2: async (sSelector: DomainGetAutocompleteV2SSelectorEnum, eFilterActive?: DomainGetAutocompleteV2EFilterActiveEnum, sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'sSelector' is not null or undefined
            assertParamExists('domainGetAutocompleteV2', 'sSelector', sSelector)
            const localVarPath = `/2/object/domain/getAutocomplete/{sSelector}`
...
export const ObjectDomainApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async domainGetAutocompleteV2(sSelector: DomainGetAutocompleteV2SSelectorEnum, eFilterActive?: DomainGetAutocompleteV2EFilterActiveEnum, sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DomainGetAutocompleteV2Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.domainGetAutocompleteV2(sSelector, eFilterActive, sQuery, acceptLanguage, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectDomainApi.domainGetAutocompleteV2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const ObjectDomainApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        domainGetAutocompleteV2(sSelector: DomainGetAutocompleteV2SSelectorEnum, eFilterActive?: DomainGetAutocompleteV2EFilterActiveEnum, sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: RawAxiosRequestConfig): AxiosPromise<DomainGetAutocompleteV2Response> {
            return localVarFp.domainGetAutocompleteV2(sSelector, eFilterActive, sQuery, acceptLanguage, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Retrieve Domain list
...
export class ObjectDomainApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public domainGetAutocompleteV2(sSelector: DomainGetAutocompleteV2SSelectorEnum, eFilterActive?: DomainGetAutocompleteV2EFilterActiveEnum, sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: RawAxiosRequestConfig) {
        return ObjectDomainApiFp(this.configuration).domainGetAutocompleteV2(sSelector, eFilterActive, sQuery, acceptLanguage, options).then((request) => request(this.axios, this.basePath));
    }
...
export const DomainGetAutocompleteV2SSelectorEnum = {
    All: 'All',
    ValidEmail: 'ValidEmail'
} as const;
export type DomainGetAutocompleteV2SSelectorEnum = typeof DomainGetAutocompleteV2SSelectorEnum[keyof typeof DomainGetAutocompleteV2SSelectorEnum];
export const DomainGetAutocompleteV2EFilterActiveEnum = {
    All: 'All',
    Active: 'Active',
    Inactive: 'Inactive'
} as const;
export type DomainGetAutocompleteV2EFilterActiveEnum = typeof DomainGetAutocompleteV2EFilterActiveEnum[keyof typeof DomainGetAutocompleteV2EFilterActiveEnum];
