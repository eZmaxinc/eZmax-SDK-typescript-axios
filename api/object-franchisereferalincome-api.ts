...
export const ObjectFranchisereferalincomeApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        franchisereferalincomeCreateObjectV2: async (franchisereferalincomeCreateObjectV2Request: FranchisereferalincomeCreateObjectV2Request, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ObjectFranchisereferalincomeApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async franchisereferalincomeCreateObjectV2(franchisereferalincomeCreateObjectV2Request: FranchisereferalincomeCreateObjectV2Request, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FranchisereferalincomeCreateObjectV2Response>> {
...
export class ObjectFranchisereferalincomeApi extends BaseAPI {
     ...
     * @memberof ObjectFranchisereferalincomeApi
     */
    public franchisereferalincomeCreateObjectV2(franchisereferalincomeCreateObjectV2Request: FranchisereferalincomeCreateObjectV2Request, options?: AxiosRequestConfig) {
