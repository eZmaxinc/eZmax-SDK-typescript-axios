...
// @ts-ignore
import type { EzsigntemplatepublicDeleteObjectV1Response } from '../model';
// @ts-ignore
import type { EzsigntemplatepublicEditObjectV1Request } from '../model';
// @ts-ignore
import type { EzsigntemplatepublicEditObjectV1Response } from '../model';
// @ts-ignore
...
export const ObjectEzsigntemplatepublicApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepublicDeleteObjectV1: async (pkiEzsigntemplatepublicID: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsigntemplatepublicID' is not null or undefined
            assertParamExists('ezsigntemplatepublicDeleteObjectV1', 'pkiEzsigntemplatepublicID', pkiEzsigntemplatepublicID)
...
export const ObjectEzsigntemplatepublicApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async ezsigntemplatepublicDeleteObjectV1(pkiEzsigntemplatepublicID: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsigntemplatepublicDeleteObjectV1Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsigntemplatepublicDeleteObjectV1(pkiEzsigntemplatepublicID, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ObjectEzsigntemplatepublicApi.ezsigntemplatepublicDeleteObjectV1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const ObjectEzsigntemplatepublicApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepublicDeleteObjectV1(pkiEzsigntemplatepublicID: number, options?: RawAxiosRequestConfig): AxiosPromise<EzsigntemplatepublicDeleteObjectV1Response> {
            return localVarFp.ezsigntemplatepublicDeleteObjectV1(pkiEzsigntemplatepublicID, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Edit an existing Ezsigntemplatepublic
         ...
         * @throws {RequiredError}
         */
        ezsigntemplatepublicEditObjectV1(pkiEzsigntemplatepublicID: number, ezsigntemplatepublicEditObjectV1Request: EzsigntemplatepublicEditObjectV1Request, options?: RawAxiosRequestConfig): AxiosPromise<EzsigntemplatepublicEditObjectV1Response> {
...
export class ObjectEzsigntemplatepublicApi extends BaseAPI {
     ...
     * @memberof ObjectEzsigntemplatepublicApi
     */
    public ezsigntemplatepublicDeleteObjectV1(pkiEzsigntemplatepublicID: number, options?: RawAxiosRequestConfig) {
        return ObjectEzsigntemplatepublicApiFp(this.configuration).ezsigntemplatepublicDeleteObjectV1(pkiEzsigntemplatepublicID, options).then((request) => request(this.axios, this.basePath));
    }
