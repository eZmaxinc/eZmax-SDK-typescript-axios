...
// @ts-ignore
import type { EzsigntsarequirementGetAutocompleteV2Response } from '../model';
// @ts-ignore
...
export const ObjectEzsigntsarequirementApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {EzsigntsarequirementGetAutocompleteV2SSelectorEnum} sSelector The type of Ezsigntsarequirements to return
         * @param {number} [fkiEzsignfoldertypeID] 
         * @param {EzsigntsarequirementGetAutocompleteV2EFilterActiveEnum} [eFilterActive] Specify which results we want to display.
...
export const ObjectEzsigntsarequirementApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        ezsigntsarequirementGetAutocompleteV2(sSelector: EzsigntsarequirementGetAutocompleteV2SSelectorEnum, fkiEzsignfoldertypeID?: number, eFilterActive?: EzsigntsarequirementGetAutocompleteV2EFilterActiveEnum, sQuery?: string, acceptLanguage?: HeaderAcceptLanguage, options?: RawAxiosRequestConfig): AxiosPromise<EzsigntsarequirementGetAutocompleteV2Response> {
