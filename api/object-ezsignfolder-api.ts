...
// @ts-ignore
import { EzsignfolderGetEzsignfoldersignerassociationsmineV1Response } from '../model';
// @ts-ignore
...
export const ObjectEzsignfolderApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        ezsignfolderGetEzsignfoldersignerassociationsmineV1: async (pkiEzsignfolderID: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'pkiEzsignfolderID' is not null or undefined
            assertParamExists('ezsignfolderGetEzsignfoldersignerassociationsmineV1', 'pkiEzsignfolderID', pkiEzsignfolderID)
            const localVarPath = `/1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignfoldersignerassociationsmine`
                .replace(`{${"pkiEzsignfolderID"}}`, encodeURIComponent(String(pkiEzsignfolderID)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            let basePath = DUMMY_BASE_URL
            if (configuration && configuration.basePath) basePath = configuration.basePath
         ...
         * @param {'pkiEzsignfolderID_ASC' | 'pkiEzsignfolderID_DESC' | 'sEzsignfolderDescription_ASC' | 'sEzsignfolderDescription_DESC' | 'dtCreatedDate_ASC' | 'dtCreatedDate_DESC' | 'fkiEzsignfoldertypeID_ASC' | 'fkiEzsignfoldertypeID_DESC' | 'sEzsignfoldertypeNameX_ASC' | 'sEzsignfoldertypeNameX_DESC' | 'eEzsignfolderStep_ASC' | 'eEzsignfolderStep_DESC' | 'dtEzsignfolderSentdate_ASC' | 'dtEzsignfolderSentdate_DESC' | 'dtEzsignfolderDuedate_ASC' | 'dtEzsignfolderDuedate_DESC' | 'iEzsigndocument_ASC' | 'iEzsigndocument_DESC' | 'iEzsigndocumentEdm_ASC' | 'iEzsigndocumentEdm_DESC' | 'iEzsignsignature_ASC' | 'iEzsignsignature_DESC' | 'iEzsignsignatureSigned_ASC' | 'iEzsignsignatureSigned_DESC'} [eOrderBy] Specify how you want the results to be sorted
         ...
         * @throws {RequiredError}
         */
        ezsignfolderGetListV1: async (eOrderBy?: 'pkiEzsignfolderID_ASC' | 'pkiEzsignfolderID_DESC' | 'sEzsignfolderDescription_ASC' | 'sEzsignfolderDescription_DESC' | 'dtCreatedDate_ASC' | 'dtCreatedDate_DESC' | 'fkiEzsignfoldertypeID_ASC' | 'fkiEzsignfoldertypeID_DESC' | 'sEzsignfoldertypeNameX_ASC' | 'sEzsignfoldertypeNameX_DESC' | 'eEzsignfolderStep_ASC' | 'eEzsignfolderStep_DESC' | 'dtEzsignfolderSentdate_ASC' | 'dtEzsignfolderSentdate_DESC' | 'dtEzsignfolderDuedate_ASC' | 'dtEzsignfolderDuedate_DESC' | 'iEzsigndocument_ASC' | 'iEzsigndocument_DESC' | 'iEzsigndocumentEdm_ASC' | 'iEzsigndocumentEdm_DESC' | 'iEzsignsignature_ASC' | 'iEzsignsignature_DESC' | 'iEzsignsignatureSigned_ASC' | 'iEzsignsignatureSigned_DESC', iRowMax?: number, iRowOffset?: number, acceptLanguage?: HeaderAcceptLanguage, sFilter?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ObjectEzsignfolderApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async ezsignfolderGetEzsignfoldersignerassociationsmineV1(pkiEzsignfolderID: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EzsignfolderGetEzsignfoldersignerassociationsmineV1Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ezsignfolderGetEzsignfoldersignerassociationsmineV1(pkiEzsignfolderID, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Return the Ezsignsignatures that can be signed by the current user at the current step in the process
...
export const ObjectEzsignfolderApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        ezsignfolderGetEzsignfoldersignerassociationsmineV1(pkiEzsignfolderID: number, options?: any): AxiosPromise<EzsignfolderGetEzsignfoldersignerassociationsmineV1Response> {
            return localVarFp.ezsignfolderGetEzsignfoldersignerassociationsmineV1(pkiEzsignfolderID, options).then((request) => request(axios, basePath));
        },
        /**
         * Return the Ezsignsignatures that can be signed by the current user at the current step in the process
         * @summary Retrieve an existing Ezsignfolder\'s automatic Ezsignsignatures
...
export class ObjectEzsignfolderApi extends BaseAPI {
     ...
     * @memberof ObjectEzsignfolderApi
     */
    public ezsignfolderGetEzsignfoldersignerassociationsmineV1(pkiEzsignfolderID: number, options?: AxiosRequestConfig) {
        return ObjectEzsignfolderApiFp(this.configuration).ezsignfolderGetEzsignfoldersignerassociationsmineV1(pkiEzsignfolderID, options).then((request) => request(this.axios, this.basePath));
    }
